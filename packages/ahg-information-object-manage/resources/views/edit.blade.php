        ...
        <div id="access-collapse" class="accordion-collapse collapse" aria-labelledby="access-heading">
          <div class="accordion-body">
            ...
            @include('ahg-core::components.autocomplete', [
                ...
                'placeholder'   => __('Type to add a subject — pick from the list to create a new row...'),
                'required'      => false,
                'idField'       => 'id',
                'nameField'     => 'name',
                'multi'         => true,
            ...
            @include('ahg-core::components.autocomplete', [
                ...
                'route'         => 'term.autocomplete',
                'placeholder'   => __('Type to add a place — pick from the list to create a new row...'),
                'required'      => false,
                'idField'       => 'id',
                'nameField'     => 'name',
                'multi'         => true,
            ...
            @include('ahg-core::components.autocomplete', [
                ...
                'route'         => 'term.autocomplete',
                'placeholder'   => __('Type to add a genre — pick from the list to create a new row...'),
                'required'      => false,
                'idField'       => 'id',
                'nameField'     => 'name',
                'multi'         => true,
            ...
            @include('ahg-core::components.autocomplete', [
                ...
                'route'         => 'actor.autocomplete',
                'placeholder'   => __('Type to add a name — pick from the list to create a new row...'),
                'required'      => false,
                'idField'       => 'id',
                'nameField'     => 'name',
                'multi'         => true,
