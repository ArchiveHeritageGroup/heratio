...
@section('title-block')
  ...
  <p class="text-muted small mb-0">Loan rules, circulation, fines, patron defaults, OPAC, ISBN providers</p>
@endsection
@section('content')
  @if(session('success'))
  ...
  <form method="post" action="{{ route('settings.ahg.library') }}">
    ...
    @endphp
    <div class="card mb-4">
      <div class="card-header"><h5 class="mb-0"><i class="fas fa-book me-2"></i>Library Settings</h5></div>
      <div class="card-body">
