...
# Heratio AHG Framework - User Manual
...
The Heratio AHG Framework extends Access to Memory (Heratio) with advanced AI-powered features for archival management. Key capabilities include:
...
- PHP `8.1+`
- MySQL `8.0+`
- Elasticsearch `6.x` (for Heratio `2.9.x`) or `7.x` (for Heratio `2.10+`)
