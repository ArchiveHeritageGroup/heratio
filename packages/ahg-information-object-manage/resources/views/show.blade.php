...
@section('content')
  ...
  <section id="identityArea" class="border-bottom">
    <h2 class="h6 mb-0 atom-section-header card-header py-2 px-3">
      <a class="text-decoration-none text-white" href="#identity-collapse">
        Identity area
      </a>
      @if(auth()->check())
        <a href="{{ route('informationobject.edit', $io->slug) }}" class="btn btn-sm btn-outline-light float-end" style="padding:1px 6px;font-size:.75rem;">
