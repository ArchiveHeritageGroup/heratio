...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center mb-4">
        ...
        <h1 class="h2 mb-0"><i class="fas fa-clipboard-list me-2"></i>{{ __('Add Processing Activity') }}</h1>
    </div>

    <form method="post" action="{{ route('ahgprivacy.ropa-add') }}">
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="name" class="form-control" required placeholder="{{ __('e.g., Customer Database Processing') }}">
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="lawful_basis" class="form-select" required>
                                    ...
                                    <option value="{{ $key }}">{{ $info['label'] }} ({{ $info['code'] }})</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="retention_period" class="form-control" placeholder="{{ __('e.g., 5 years after contract ends') }}">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input type="checkbox" name="dpia_required" value="1" class="form-check-input" id="dpia_required">
                                    <label class="form-check-label" for="dpia_required">{{ __('DPIA Required') }}</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input type="checkbox" name="dpia_completed" value="1" class="form-check-input" id="dpia_completed">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="assigned_officer_id" class="form-select">
                                ...
                                <option value="{{ $officer->id }}">{{ $officer->name }} ({{ $officer->jurisdiction }})</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
