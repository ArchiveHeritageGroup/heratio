...
The Semantic Search system provides query expansion capabilities for Heratio archives using a thesaurus-based approach. It integrates with Elasticsearch for search optimization and supports multiple data sources including WordNet, Wikidata, and local synonym definitions.
