...
<div class="row">  <div class="col-12">
    ...
    <p class="text-muted">View and manage your access requests.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-key me-2"></i>My Access Requests</div>
      <div class="card-body">
        @if(!empty($items))
