...
@section('content')
  ...
  <div class="card-body"><form method="POST" action="{{ $formAction ?? '#' }}">@csrf
    <div class="mb-3"><label class="form-label">Borrower <span class="badge bg-secondary">field</span></label><input type="text" class="form-control" name="borrower"></div><div class="mb-3"><label class="form-label">Purpose <span class="badge bg-secondary">field</span></label><textarea class="form-control" name="purpose" rows="2"></textarea></div><div class="row"><div class="col-md-6 mb-3"><label class="form-label">Start Date <span class="badge bg-secondary">field</span></label><input type="date" class="form-control" name="start_date"></div><div class="col-md-6 mb-3"><label class="form-label">End Date <span class="badge bg-secondary">field</span></label><input type="date" class="form-control" name="end_date"></div></div>
