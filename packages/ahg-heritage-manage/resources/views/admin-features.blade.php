...
<div class="row">
  ...
  <div class="col-md-9">
    ...
    <p class="text-muted">Enable or disable heritage portal features.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-toggle-on me-2"></i>Feature Toggles</div>
      <div class="card-body">
