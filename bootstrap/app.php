...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        // Phase 3 of #677 - Prometheus instrumentation. Registered as a GLOBAL
        // middleware (the package's documented intent) rather than web-group:
        //   - counts ALL requests (web + api + anonymous/401), and
        //   - global terminable middleware are reliably terminated, so the
        //     terminate()-deferred counters fire (web-group terminate() does
        //     not run in every kernel/test path). Runs before auth so blocked
