...
@section('sidebar')
  ...
  @if($researcher ?? false)
    <div class="card mb-4">
      <div class="card-header small fw-bold">Your Information</div>
...
@section('content')
  ...
  <form action="{{ route('research.book.store') }}" method="POST">
    ...
    <div class="card mb-4">
      <div class="card-header"><i class="fas fa-door-open me-2"></i>Select Reading Room</div>
      <div class="card-body">
        <div class="row">
    ...
    {{-- Date & Time --}}
    <div class="card mb-4">
      <div class="card-header"><i class="fas fa-clock me-2"></i>Date &amp; Time</div>
      <div class="card-body">
        <div class="row">
    ...
    {{-- Material Requests --}}
    <div class="card mb-4">
      <div class="card-header"><i class="fas fa-archive me-2"></i>Material Requests</div>
      <div class="card-body">
        ...
        <div id="material-requests">
          <div class="input-group mb-2">
            ...
            <button type="button" class="btn btn-outline-success btn-add-material"><i class="fas fa-plus"></i></button>
          </div>
        </div>
      ...
      document.addEventListener('click', function(e) {
        if (e.target.closest('.btn-add-material')) {
          ...
          div.innerHTML = '<input type="text" name="materials[]" class="form-control" placeholder="Reference number or description of material">' +
            '<button type="button" class="btn btn-outline-danger btn-remove-material"><i class="fas fa-minus"></i></button>';
