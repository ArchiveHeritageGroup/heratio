...
@section('title', 'Edit Privacy Officer')

@section('content')
<h1>Edit Privacy Officer</h1>
  ...
  <div class="accordion mb-3">
    <div class="accordion-item">
      <h2 class="accordion-header">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#main-collapse" aria-expanded="true">Edit Privacy Officer</button>
      </h2>
