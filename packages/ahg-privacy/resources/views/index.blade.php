...
<div class="d-flex align-items-center mb-3">
  {{-- Back to the DSAR records list (the privacy module's primary record set). --}}
  <a href="{{ route('ahgprivacy.dsar-list') }}" class="btn btn-outline-secondary btn-sm me-3" title="{{ __('Back to records') }}">
