...
@if(\AhgCore\Models\Term::ROOT_ID != $resource->parent->id)
...
@php $relatedTerms = \AhgCore\Models\Relation::getBySubjectOrObjectId($resource->id, ['typeId' => \AhgCore\Models\Term::TERM_RELATION_ASSOCIATIVE_ID]); @endphp
