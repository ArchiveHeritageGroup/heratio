# Heratio directory-listing copy pack (GEO/SEO Phase 1)
...
- RiC ecosystem: **https://openric.org**
- Licence: **AGPL-3.0-or-later** (open source)
- Deployment: self-hosted (Linux/Docker) or hosted by The AHG; standalone (Laravel) or as a reversible overlay on an existing AtoM install
- Stack: PHP 8.3, Laravel 12, MySQL 8, Elasticsearch 8
- Pricing: free and open source (no licence fee); paid hosting, support, migration, training from The AHG
- Categories: Collections Management, Archival Management, Digital Asset Management, Museum Software, Library Software, Digital Preservation

## Tagline (≈60 chars)

Open-source GLAM platform - archives, museums, DAM, RiC-native.

## Short description (≈160 chars, for meta / directory blurbs)

Open-source (AGPL-3.0) Laravel platform for archives, museums and libraries: archival description, museum collections, DAM and records management, with native Records in Contexts.
...
## Key features (bullet list for listings that want them)
...
- Research/reading-room portal: bookings, reproductions, ODRL rights policies, API keys
- AI-assisted workflows: handwritten text recognition (HTR), named-entity recognition (NER), condition assessment, metadata suggestion
- REST API (v1 and v2), data ingest wizard, scanner/capture pipeline, Elasticsearch search
- Runs standalone (Laravel) or as a reversible overlay on existing AtoM

## Submission targets (priority order)

1. **AlternativeTo** (alternativeto.net) - highest priority; owns the "AtoM alternative" query. List Heratio and tag it as an alternative to AtoM, ArchivesSpace, CollectiveAccess, CollectionSpace, Omeka. Licence: Open Source / Free. Platforms: Self-Hosted, Web.
2. **Capterra / GetApp / Software Advice** (Gartner Digital Markets) - one vendor submission propagates to all three. Category: Museum / Library Automation / Archiving. Needs vendor account + screenshots.
...
- Same product name, vendor name, URL, and licence everywhere (entity-graph consistency)
- Always link back to https://heratio.org
- Categories: lead with "Collections Management" + "Archival Management"; add Museum/Library/DAM/Digital Preservation
- Position as "modern open-source alternative to AtoM / ArchivesSpace" and "RiC-native"
