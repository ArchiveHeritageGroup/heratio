...
### Information Objects
Links to Heratio's `information_object` table via `exhibition_object.information_object_id`.
...
### Access Control
The plugin uses Heratio's standard ACL system. No custom permissions are defined.
