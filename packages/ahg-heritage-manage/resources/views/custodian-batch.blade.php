...
<div class="row">
  ...
  <div class="col-md-9">
    ...
    <p class="text-muted">Run batch operations on heritage items.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-layer-group me-2"></i>Batch Operations</div>
      <div class="card-body">
        @if(!empty($items))
