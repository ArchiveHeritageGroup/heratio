...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/library-manage/acquisition/order/{id}/line/{lineId}/funds', [LibraryAcquisitionController::class, 'lineFunds'])->name('library.acquisition-order-line-funds')->where(['id' => '[0-9]+', 'lineId' => '[0-9]+']); // #1311 multi-fund splitting
    Route::put('/library-manage/acquisition/order/{id}/line/{lineId}/funds', [LibraryAcquisitionController::class, 'saveLineFunds'])->name('library.acquisition-order-line-funds-save')->where(['id' => '[0-9]+', 'lineId' => '[0-9]+'])->middleware('acl:update'); // #1311 multi-fund splitting
