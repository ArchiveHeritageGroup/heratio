...
```
Heratio_Heratio_{ComponentName}_Feature_Overview.md
Heratio_Heratio_{ComponentName}_Feature_Overview.docx
```
Example: `Heratio_Heratio_DataIngest_Feature_Overview.md`
