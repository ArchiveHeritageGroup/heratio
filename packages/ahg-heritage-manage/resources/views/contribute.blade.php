        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade {{ ($selectedType ?? '')===$opp['code']?'show active':'' }}" id="form-{{ $opp['code'] }}" role="tabpanel">
            ...
            <form class="contribution-form">@csrf
              ...
              <div class="mb-3"><label class="form-label">Name <span class="text-danger">*</span> <span class="badge bg-danger ms-1">Required</span></label><input type="text" class="form-control" name="content[name]" required minlength="2" placeholder="Full name of the person identified"></div>
              ...
              <div class="mb-3"><label class="form-label">How confident are you? <span class="badge bg-secondary ms-1">Optional</span></label><select class="form-select" name="content[confidence]"><option value="certain">Certain</option><option value="likely">Likely</option><option value="possible">Possible</option></select></div>
              ...
              <div class="mb-3"><label class="form-label">Your Context <span class="text-danger">*</span> <span class="badge bg-danger ms-1">Required</span></label><textarea class="form-control" name="content[text]" rows="8" required minlength="20" placeholder="Share what you know..."></textarea></div>
              ...
              <div class="mb-3"><label class="form-label">Translation <span class="text-danger">*</span> <span class="badge bg-danger ms-1">Required</span></label><textarea class="form-control" name="content[text]" rows="8" required placeholder="Your translation..."></textarea></div>
              @endif
