...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/embargo/{objectId}/add', [EmbargoController::class, 'store'])->name('embargo.store')->where('objectId', '[0-9]+');
    ...
    Route::post('/embargo/{id}/lift', [EmbargoController::class, 'lift'])->name('embargo.lift')->where('id', '[0-9]+');
    ...
    Route::post('/extended-rights/batch', [ExtendedRightsController::class, 'batchStore'])->name('extended-rights.batch.store');
    ...
    Route::post('/extended-rights/{slug}/clear', [ExtendedRightsController::class, 'clearStore'])->name('extended-rights.clear.store');
...
Route::middleware('admin')->group(function () {
    ...
    Route::put('/rights-admin/embargoes/{id}', [RightsAdminController::class, 'embargoUpdate'])->name('rights-admin.embargo-update')->where('id', '[0-9]+');
    ...
    Route::put('/rights-admin/orphan-works/{id}', [RightsAdminController::class, 'orphanWorkUpdate'])->name('rights-admin.orphan-work-update')->where('id', '[0-9]+');
