...
//
//   APP_URL=https://heratio.theahg.co.za node tests/e2e/helpers/iiif-demo-capture.mjs
//
// Output: tests/e2e/artifacts/iiif-demo/iiif-deepzoom.webm
...
const OUT_DIR = new URL('../artifacts/iiif-demo/', import.meta.url).pathname;
const W = 1280, H = 720;
