...
### 1.12 Base Heratio REST API (arRestApiPlugin)

**Location:** `/plugins/arRestApiPlugin/` (base Heratio — read-only)
...
### 3.1 Base Heratio OAI-PMH (arOaiPlugin)
...
| `/admin/doi/mapping` | GET/POST | Heratio→DataCite field mapping |
...
| `ahg_doi_mapping` | Heratio→DataCite field mapping |
...
Overrides base Heratio search endpoints:
...
### 8.1 Standard Export Formats (Base Heratio)
...
| Standard Export | Base Heratio | Complete | EAD, DC, CSV, MODS, SKOS |
