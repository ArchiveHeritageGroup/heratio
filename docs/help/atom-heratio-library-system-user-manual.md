...
The Heratio Library System is a full Integrated Library System (ILS) embedded within the Heratio archival platform. It is delivered through the ahgLibraryPlugin and is designed for institutions that manage lending libraries alongside archival, museum, gallery, or digital asset collections.
...
The Library System is accessed through the main Heratio navigation. Once the ahgLibraryPlugin is enabled, the following navigation entries become available:
...
- Deletion removes the library metadata record. The underlying Heratio information object is not affected.
