...
The ahgGalleryPlugin provides comprehensive gallery and art museum management functionality for Heratio, implementing the **Cataloguing Cultural Objects (CCO)** and **VRA Core** metadata standards. It manages artists, loans (incoming/outgoing), valuations, insurance policies, venues, gallery spaces, and facility reports.
...
CREATE TABLE gallery_artist (
  ...
  actor_id INT DEFAULT NULL,                    -- Links to Heratio actor
...
*Part of the Heratio AHG Framework - Version 1.2.10*
