...
@section('title', 'Edit Dropdown Value')

@section('content')
<h1>{{ __('Edit Dropdown Value') }}</h1>
  ...
  <div class="accordion mb-3">
    <div class="accordion-item">
      <h2 class="accordion-header">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#main-collapse" aria-expanded="true">{{ __('Edit Dropdown Value') }}</button>
      </h2>
