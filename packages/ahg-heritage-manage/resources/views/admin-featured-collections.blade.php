...
<div class="row">
  ...
  <div class="col-md-9">
    ...
    <p class="text-muted">Select and manage featured collections shown on the landing page.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-star me-2"></i>Featured Collections</div>
      <div class="card-body">
