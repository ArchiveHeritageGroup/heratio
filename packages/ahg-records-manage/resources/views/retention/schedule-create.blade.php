...
@section('title-block')
  <div class="multiline-header d-flex align-items-center mb-3">
    ...
    <div class="d-flex flex-column"><h1 class="mb-0">{{ __('Create Retention Schedule') }}</h1><span class="small text-muted">{{ __('Records management — new retention schedule') }}</span></div>
  </div>
@endsection
@section('content')
