        ...
        <div class="accordion-item">
          ...
          <div id="collapseOai" class="accordion-collapse collapse show" data-bs-parent="#settingsAccordion">
            <div class="accordion-body">
              ...
              <div class="mb-3">
                <label class="form-label">Enable OAI authentication <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="mb-3">
                <label class="form-label">Repository code <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="mb-3">
                <label class="form-label">Repository identifier <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
                <input type="text" name="settings[oai_repository_identifier]" class="form-control" value="{{ e($settings['oai_repository_identifier'] ?? '') }}">
              </div>
              <div class="mb-3">
                <label class="form-label">Sample OAI identifier <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
                <input type="text" name="settings[sample_oai_identifier]" class="form-control" value="{{ e($settings['sample_oai_identifier'] ?? '') }}">
              </div>
              <div class="mb-3">
                <label class="form-label">Resumption token limit <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
                <input type="number" name="settings[resumption_token_limit]" class="form-control" value="{{ e($settings['resumption_token_limit'] ?? '100') }}">
              </div>
              <div class="mb-3">
                <label class="form-label">Enable additional sets <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
