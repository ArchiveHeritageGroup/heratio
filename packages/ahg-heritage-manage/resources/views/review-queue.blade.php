...
<div class="row">  <div class="col-md-3">@include('ahg-heritage-manage::partials._admin-sidebar')</div>
  <div class="col-md-9">
    ...
    <p class="text-muted">Pending contributions awaiting review.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-inbox me-2"></i>Review Queue</div>
      <div class="card-body">
        @if(!empty($items))
