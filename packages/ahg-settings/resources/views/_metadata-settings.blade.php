...
<div class="card mb-4">
  ...
  <div class="card-body">
    <div class="form-check form-switch mb-3">
      ...
      <label class="form-check-label" for="meta_extract">Extract metadata on upload <span class="badge bg-secondary ms-1">Recommended</span></label>
    </div>
    <div class="form-check form-switch mb-3">
    ...
    @foreach(['images', 'pdf', 'office', 'video', 'audio'] as $type)
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" for="meta_{{ $type }}">{{ ucfirst($type) }} <span class="badge bg-secondary ms-1">Optional</span></label>
      </div>
    @endforeach
  </div>
</div>
