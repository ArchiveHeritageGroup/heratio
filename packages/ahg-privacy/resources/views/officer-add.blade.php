...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center mb-4">
        ...
        <h1 class="h2 mb-0"><i class="fas fa-user-tie me-2"></i>{{ __('Add Privacy Officer') }}</h1>
    </div>

    <form method="post" action="{{ route('ahgprivacy.officer-add') }}">
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="registration_number" class="form-control" placeholder="{{ __('e.g., IO registration with regulator') }}">
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="fas fa-save me-2"></i>{{ __('Add Officer') }}
                            </button>
