...
/**
 * ImportArchivesCsvCommand - Artisan command for archives CSV import.
 *
...
namespace AhgInformationObjectManage\Console\Commands;
...
class ImportArchivesCsvCommand extends Command
{
    ...
    protected $description = 'Import archives CSV data with ISAD(G) validation';
    ...
    public function handle(): int
    {
        ...
        $importer = new ArchivesCsvImporter();
        ...
        $this->info(sprintf('Processing %s for sector: archives (ISAD(G))', basename($filename)));
