...
<div class="row">
  ...
  <div class="col-md-9">
    <h1><i class="fas fa-plus me-2"></i>{{ __('Add Rule') }}</h1>
    <p class="text-muted">Add a new accounting rule.</p>
    ...
    <form method="post" action="{{ $formAction ?? '#' }}">
      ...
      <div class="card mb-3">
        <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-plus me-2"></i>{{ __('Add Rule') }}</div>
        <div class="card-body">
