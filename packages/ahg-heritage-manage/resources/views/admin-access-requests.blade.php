...
<div class="row">
  ...
  <div class="col-md-9">
    ...
    <p class="text-muted">Manage user access requests to restricted materials.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-key me-2"></i>Access Requests</div>
      <div class="card-body">
