...
@section('title', 'Edit Processing Activity')
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col">
            ...
            <h1><i class="fas fa-cogs me-2"></i>{{ __('Edit Processing Activity') }}</h1>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-8">
                            ...
                            <input type="text" name="name" class="form-control" autocomplete="off" value="{{ $activity->name ?? '' }}" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="category" class="form-select">
                                ...
                                <option value="operations" {{ ($activity->category ?? '') === 'operations' ? 'selected' : '' }}>Operations</option>
                                <option value="archive" {{ ($activity->category ?? '') === 'archive' ? 'selected' : '' }}>Archives</option>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="purpose" class="form-control" rows="3" required>{{ $activity->purpose ?? '' }}</textarea>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select name="legal_basis" class="form-select" required>
                                ...
                                <option value="vital_interest" {{ ($activity->legal_basis ?? '') === 'vital_interest' ? 'selected' : '' }}>Vital Interest</option>
                                <option value="public_interest" {{ ($activity->legal_basis ?? '') === 'public_interest' ? 'selected' : '' }}>Public Interest</option>
                                <option value="legitimate_interest" {{ ($activity->legal_basis ?? '') === 'legitimate_interest' ? 'selected' : '' }}>Legitimate Interest</option>
                            </select>
                        </div>
                        <div class="col-md-6">
