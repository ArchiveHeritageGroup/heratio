...
<div class="card">
    <div class="card-body">
        <form method="POST" autocomplete="off">
            ...
            <div class="row mb-3">
                <div class="col-md-4"><label class="form-label">Max Advance Booking Days <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label><input type="number" name="max_booking_days_advance" class="form-control" value="{{ $type->max_booking_days_advance ?? 30 }}"></div>
                <div class="col-md-4"><label class="form-label">Max Hours per Day <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label><input type="number" name="max_booking_hours_per_day" class="form-control" value="{{ $type->max_booking_hours_per_day ?? 8 }}"></div>
                <div class="col-md-4"><label class="form-label">Max Materials <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label><input type="number" name="max_materials_per_booking" class="form-control" value="{{ $type->max_materials_per_booking ?? 5 }}"></div>
            </div>
