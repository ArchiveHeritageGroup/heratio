...
-- Field Mappings (connect form fields to Heratio fields)
...
3. If not, fall back to standard Heratio form
4. Form submission saves via normal Heratio process
