...
<form method="POST" action="{{ $isEdit ? route('research.milestones.update', [$project->id ?? 0, $milestone['id']]) : route('research.milestones.store', $project->id ?? 0) }}">
    @csrf
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-8">
                    ...
                    <input type="text" name="title" class="form-control" maxlength="512" required value="{{ old('title', $milestone['title'] ?? '') }}" placeholder="{{ __('name of the milestone or deliverable') }}">
                </div>
                <div class="col-md-4">
