  ...
  <div class="col-md-9">
    ...
    <form method="post" action="{{ $formAction ?? '#' }}">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-6 mb-3"><label class="form-label">Package Type <span class="badge bg-secondary ms-1">Optional</span></label>
            ...
            <div class="col-md-6 mb-3"><label class="form-label">Status <span class="badge bg-secondary ms-1">Optional</span></label>
            ...
            <div class="col-12 mb-3"><label class="form-label">Description <span class="badge bg-secondary ms-1">Optional</span></label>
