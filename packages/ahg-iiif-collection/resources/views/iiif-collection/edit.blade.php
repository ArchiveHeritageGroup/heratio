...
<div class="sidebar-content">
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('iiif-collection.view', $collection->id) }}" class="btn btn-outline-primary w-100 mb-2">
                <i class="fas fa-eye me-2"></i>View Collection
            </a>
            <a href="{{ route('iiif-collection.add-items', $collection->id) }}" class="btn btn-outline-success w-100">
...
<div class="iiif-collection-form">
    <form method="POST" action="{{ route('iiif-collection.update', $collection->id) }}">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('iiif-collection.view', $collection->id) }}" class="btn btn-outline-secondary">
