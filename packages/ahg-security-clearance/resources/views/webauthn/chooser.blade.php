      ...
      <div class="card">
        ...
        <div class="card-body">
          <p class="text-muted text-center">
            {{ __('You have more than one factor enrolled. Pick one to complete sign-in.') }}
          </p>
          ...
          <div class="row g-3 mt-3">
            ...
            @if(!empty($hasOtp))
              <div class="col-md-4">
                <a href="{{ route('security-clearance.otp.verify', ['return' => $returnUrl]) }}"
                   class="btn btn-outline-primary btn-lg w-100 py-4">
                  <i class="bi bi-envelope-fill fs-2 d-block mb-2"></i>
                  {{ __('Email or SMS code') }}
                  <div class="small mt-1">{{ __('6-digit code delivered to your verified email or phone') }}</div>
                </a>
              </div>
            @endif
          </div>
