...
<div class="row">
  ...
  <div class="col-md-9">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1><i class="fas fa-cube me-2"></i>Custodian Item</h1>
      <a href="{{ route('heritage.custodian') }}" class="btn btn-sm atom-btn-white"><i class="fas fa-arrow-left me-1"></i>Back</a>
    </div>
    <p class="text-muted">View and manage a specific custodian item.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-cube me-2"></i>Custodian Item</div>
      <div class="card-body">
        @if(!empty($items))
