...
<div class="multiline-header d-flex align-items-center mb-3">
  ...
  <div class="d-flex flex-column">
    ...
    <span class="small text-muted">{{ __('Configure backup storage and retention') }}</span>
  </div>
</div>
...
<div class="card">
  ...
  <div class="card-body">
    <form method="post" action="{{ route('backup.saveSettings') }}">
      ...
      <div class="mb-3">
        <label for="backup_path" class="form-label">Backup Path <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
            <label for="backup_max_backups" class="form-label">Max Backups <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
        ...
        <div class="col-md-6">
          <div class="mb-3">
            <label for="backup_retention_days" class="form-label">Retention Days <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
