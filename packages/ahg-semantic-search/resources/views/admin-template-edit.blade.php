...
@section('title', 'New Search Template')

@section('content')
<h1>New Search Template</h1>
  ...
  <div class="accordion mb-3">
    <div class="accordion-item">
      <h2 class="accordion-header">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#main-collapse" aria-expanded="true">New Search Template</button>
      </h2>
