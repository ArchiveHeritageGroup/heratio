...
<div class="card">
    <div class="card-body">
        <form method="POST">
            @csrf
            <div class="row mb-3">
                <div class="col-md-8"><label class="form-label">Name <span class="text-danger">*</span> <span class="badge bg-danger ms-1">Required</span></label><input type="text" name="name" class="form-control" required value="{{ e($institution->name ?? '') }}"></div>
                <div class="col-md-4"><label class="form-label">Code <span class="badge bg-secondary ms-1">Optional</span></label><input type="text" name="code" class="form-control" value="{{ e($institution->code ?? '') }}"></div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6"><label class="form-label">Contact Email <span class="badge bg-secondary ms-1">Optional</span></label><input type="email" name="email" class="form-control" value="{{ e($institution->email ?? '') }}"></div>
                <div class="col-md-6"><label class="form-label">Phone <span class="badge bg-secondary ms-1">Optional</span></label><input type="text" name="phone" class="form-control" value="{{ e($institution->phone ?? '') }}"></div>
            </div>
