...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/library-manage/{slug}/rename', [LibraryController::class, 'renameStore'])->name('library.rename-store');
    ...
    Route::post('/library-manage/isbn-provider/{id}', [LibraryController::class, 'isbnProviderStore'])->name('library.isbn-provider-store')->where('id', '[0-9]+');
    ...
    Route::post('/library-manage/acquisition/batch-capture', [LibraryController::class, 'batchCaptureLookup'])->name('library.batch-capture-lookup');
    ...
    Route::post('/library-manage/acquisition/order/{id}', [LibraryController::class, 'acquisitionOrderStore'])->name('library.acquisition-order-store')->where('id', '[0-9]+');
    ...
    Route::post('/library-manage/isbn-lookup', [LibraryController::class, 'isbnLookupSearch'])->name('library.isbn-lookup-search');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/opac/hold/{slug}', [LibraryController::class, 'opacHoldStore'])->name('library.opac-hold-store');
    Route::post('/opac/renew/{id}', [LibraryController::class, 'opacRenew'])->name('library.opac-renew')->where('id', '[0-9]+');
});
