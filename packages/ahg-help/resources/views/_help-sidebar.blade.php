...
<div class="help-sidebar"><div class="card"><div class="card-header fw-semibold" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-life-ring me-2"></i>{{ __('Help Topics') }}</div>
