        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">{{ __('Configuration') }}</h5>
                </div>
                <div class="card-body">
                    <form method="post">
                        @csrf
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="geoip_enabled">{{ __('Enable GeoIP Lookup') }}</label>
                            </div>
                        </div>
                        ...
                        <hr>
                        <h6>{{ __('Privacy and Filtering') }}</h6>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="bot_filtering_enabled">{{ __('Enable Bot Filtering') }}</label>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="exclude_admin_views">{{ __('Exclude Admin Page Views') }}</label>
                            </div>
                        </div>
