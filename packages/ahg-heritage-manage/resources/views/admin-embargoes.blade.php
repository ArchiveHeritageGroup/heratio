...
<div class="row">
  ...
  <div class="col-md-9">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1><i class="fas fa-lock me-2"></i>Embargoes</h1>
    </div>
    <p class="text-muted">Manage embargo periods and access restrictions on collections.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-lock me-2"></i>Embargoes</div>
      <div class="card-body">
