...
<div class="card"><div class="card-body"><form method="post" action="{{ route('library.acquisition-budget-store') }}" autocomplete="off">@csrf
<div class="row"><div class="col-md-6 mb-3"><label class="form-label">{{ __('Fund Name') }} <span class="text-danger">*</span></label><input type="text" name="fund_name" autocomplete="off" class="form-control" value="{{ old('fund_name') }}" required></div>
