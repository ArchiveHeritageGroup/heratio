            ...
            <div class="col-md-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="metadata_prefix" class="form-label">Metadata Prefix</label>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="set_spec" class="form-label">Set Spec (optional)</label>
                        ...
                        <div class="mb-3">
                            <label for="harvest_interval" class="form-label">Harvest Interval (hours)</label>
