...
/**
 * ImportGalleryCsvCommand - Artisan command for gallery CSV import.
 *
...
use AhgGallery\Services\GalleryCsvImporter;
use Illuminate\Console\Command;

class ImportGalleryCsvCommand extends Command
{
    protected $signature = 'sector:gallery-csv-import
    ...
    protected $description = 'Import gallery CSV data with CCO validation';
    ...
    public function handle(): int
    {
        ...
        $importer = new GalleryCsvImporter();
        ...
        $this->info(sprintf('Processing %s for sector: gallery (CCO)', basename($filename)));
    ...
    protected function runValidation(GalleryCsvImporter $importer, string $filename): int
    {
