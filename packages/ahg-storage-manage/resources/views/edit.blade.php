  ...
  <form method="POST" action="{{ $storage ? route('physicalobject.update', $storage->slug) : route('physicalobject.store') }}">
    ...
    <div class="row">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="type_id" class="form-label">Type <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
            ...
            <div class="mb-3">
              <label for="location" class="form-label">Location (legacy) <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              <input type="text" name="location" id="location" class="form-control"
                     value="{{ old('location', $storage->location ?? '') }}"
                     placeholder="{{ __('Use extended location fields below instead') }}">
              <small class="text-muted">{{ __('For backwards compatibility. Use the detailed fields below.') }}</small>
            </div>
          </div>
        </div>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-4">
                <div class="mb-3">
                  <label for="building" class="form-label">Building <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  <label for="floor" class="form-label">Floor <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  <label for="room" class="form-label">Room <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="mb-3">
                  <label for="aisle" class="form-label">Aisle <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-md-3">
                <div class="mb-3">
                  <label for="bay" class="form-label">Bay <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-md-3">
                <div class="mb-3">
                  <label for="rack" class="form-label">Rack <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-md-3">
                <div class="mb-3">
                  <label for="shelf" class="form-label">Shelf <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  <label for="barcode" class="form-label">Barcode <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  <label for="reference_code" class="form-label">Reference Code <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-4">
                <div class="mb-3">
                  <label for="width" class="form-label">Width <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  <label for="height" class="form-label">Height <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  <label for="depth" class="form-label">Depth <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-4">
                <div class="mb-3">
                  <label for="total_capacity" class="form-label">Total Capacity <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  <label for="used_capacity" class="form-label">Used Capacity <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  <label for="capacity_unit" class="form-label">Capacity Unit <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
            ...
            @if(!empty($extendedData['total_capacity']))
              ...
              @endphp
              <div class="mb-3">
                <label class="form-label">Capacity Usage <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="total_linear_metres" class="form-label">Total Linear Metres <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="used_linear_metres" class="form-label">Used Linear Metres <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
      ...
      <div class="col-md-4">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="mb-3">
              <label for="status" class="form-label">Status <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="mb-3 form-check">
              ...
              <label class="form-check-label" for="climate_controlled">Climate Controlled <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
            </div>
            <div class="row">
              <div class="col-6">
                <div class="mb-3">
                  <label for="temperature_min" class="form-label">Temp Min (°C) <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-6">
                <div class="mb-3">
                  <label for="temperature_max" class="form-label">Temp Max (°C) <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
            ...
            <div class="row">
              <div class="col-6">
                <div class="mb-3">
                  <label for="humidity_min" class="form-label">Humidity Min (%) <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
              ...
              <div class="col-6">
                <div class="mb-3">
                  <label for="humidity_max" class="form-label">Humidity Max (%) <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="mb-3">
              <label for="security_level" class="form-label">Security Level <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
            ...
            <div class="mb-3">
              <label for="access_restrictions" class="form-label">Access Restrictions <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
    ...
    <section class="actions mb-3">
      <ul class="actions mb-1 nav gap-2">
        ...
        @endif
        <li><a href="{{ route('physicalobject.browse') }}" class="btn atom-btn-outline-light" role="button"><i class="fas fa-list me-1"></i>{{ __('Browse physical objects') }}</a></li>
      </ul>
    </section>
  </form>
@endsection
