...
<div class="row">
  ...
  <div class="col-md-9">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1><i class="fas fa-pencil-alt me-2"></i>{{ __('Edit Report') }}</h1>
      <a href="{{ route('reports.builder.index') }}" class="btn btn-sm atom-btn-white"><i class="fas fa-arrow-left me-1"></i>{{ __('Back') }}</a>
    </div>
    <p class="text-muted">Edit and configure your custom report.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-pencil-alt me-2"></i>{{ __('Edit Report') }}</div>
      <div class="card-body">
        @if(isset($report))
