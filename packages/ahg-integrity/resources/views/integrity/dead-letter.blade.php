...
@section('title-block')
  <div class="multiline-header d-flex align-items-center mb-3">
    ...
    <div class="d-flex flex-column"><h1 class="mb-0">Dead Letter</h1><span class="small text-muted">Digital object integrity management</span></div>
  </div>
@endsection
@section('content')
<div class="card">
  <div class="card-header" style="background-color:var(--ahg-card-header-bg, #005837);color:var(--ahg-card-header-text, #fff);"><h5 class="mb-0">Dead Letter Queue</h5></div>
  <div class="card-body p-0">
    @if(isset($deadLetters) && count($deadLetters) > 0)
    <table class="table table-striped table-hover mb-0"><thead><tr style="background-color:var(--ahg-card-header-bg, #005837);color:var(--ahg-card-header-text, #fff);"><th>ID</th><th>Object</th><th>Failure Type</th><th>Message</th><th>Date</th><th>Status</th></tr></thead>
