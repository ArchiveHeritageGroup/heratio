  ...
  <form method="POST" action="{{ route('library.trading-partners.update', $partner->id) }}" autocomplete="off">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        ...
        <input name="edi_partner_code" autocomplete="off" value="{{ old('edi_partner_code', $partner->edi_partner_code) }}" class="form-control" maxlength="20" required>
        ...
        <div class="card bg-light">
          ...
          <div class="card-body">
            <div class="row g-2">
              ...
              <div class="col-md-2"><label class="form-label">{{ __('Port') }}</label><input name="endpoint_config[port]" value="{{ old('endpoint_config.port', $cfg['port'] ?? 22) }}" class="form-control"></div>
              <div class="col-md-3"><label class="form-label">{{ __('Username') }}</label><input name="endpoint_config[username]" value="{{ old('endpoint_config.username', $cfg['username'] ?? '') }}" class="form-control"></div>
              <div class="col-md-3"><label class="form-label">{{ __('Password') }}</label><input name="endpoint_config[password]" type="password" value="{{ old('endpoint_config.password', $cfg['password'] ?? '') }}" class="form-control" placeholder="{{ __('leave blank to keep') }}"></div>
              <div class="col-md-6"><label class="form-label">{{ __('Outbound Directory') }}</label><input name="outbound_directory" value="{{ old('outbound_directory', $partner->outbound_directory) }}" class="form-control"></div>
              <div class="col-md-6"><label class="form-label">{{ __('Inbound Directory') }}</label><input name="inbound_directory" value="{{ old('inbound_directory', $partner->inbound_directory) }}" class="form-control"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card bg-light">
          ...
          <div class="card-body">
            <div class="row g-2">
              ...
              <div class="col-md-4"><label class="form-label">{{ __('Receiver ID') }}</label><input name="endpoint_config[as2_receiver_id]" value="{{ old('endpoint_config.as2_receiver_id', $cfg['as2_receiver_id'] ?? '') }}" class="form-control"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card bg-light">
          ...
          <div class="card-body">
            <div class="row g-2">
              ...
              <div class="col-md-2"><label class="form-label">{{ __('Port') }}</label><input name="endpoint_config[smtp_port]" value="{{ old('endpoint_config.smtp_port', $cfg['smtp_port'] ?? 587) }}" class="form-control"></div>
              <div class="col-md-3"><label class="form-label">{{ __('From') }}</label><input name="endpoint_config[smtp_from]" value="{{ old('endpoint_config.smtp_from', $cfg['smtp_from'] ?? '') }}" class="form-control"></div>
              <div class="col-md-3"><label class="form-label">{{ __('To (EDI mailbox)') }}</label><input name="endpoint_config[smtp_to]" value="{{ old('endpoint_config.smtp_to', $cfg['smtp_to'] ?? '') }}" class="form-control"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12">
        <button type="submit" class="btn btn-primary">{{ __('Update Partner') }}</button>
      </div>
    </div>
  </form>
</x-library-layout>
