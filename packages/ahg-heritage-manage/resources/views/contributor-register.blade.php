    ...
    <div class="card border-0 shadow-sm">
      <div class="card-body p-4">
        ...
        <div class="text-center mb-4">
          ...
          <h2 class="h4 mt-3">{{ __('Join Our Community') }}</h2>
...
<div class="modal fade" id="termsModal" tabindex="-1">
  <div class="modal-dialog modal-lg"><div class="modal-content">
    <div class="modal-header"><h5 class="modal-title">{{ __('Contributor Terms and Conditions') }}</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
    <div class="modal-body">
      <h6>{{ __('1. Contribution Guidelines') }}</h6><p>By contributing to this heritage collection, you agree to:</p><ul><li>Provide accurate and truthful information</li><li>Not submit copyrighted material without permission</li><li>Respect the privacy of individuals mentioned in records</li><li>Not submit offensive, defamatory, or inappropriate content</li></ul>
      <h6>{{ __('2. Review Process') }}</h6><p>All contributions are reviewed by our team before publication. We reserve the right to:</p><ul><li>Edit contributions for clarity and accuracy</li><li>Reject contributions that don't meet our guidelines</li><li>Request additional information or verification</li></ul>
      <h6>{{ __('3. Intellectual Property') }}</h6><p>By submitting a contribution, you grant us a non-exclusive license to use, display, and distribute your contribution as part of our heritage collection.</p>
      <h6>{{ __('4. Privacy') }}</h6><p>Your personal information will be used in accordance with our privacy policy. Your display name will be shown alongside your contributions.</p>
    </div>
    <div class="modal-footer"><button type="button" class="btn atom-btn-white" data-bs-dismiss="modal">{{ __('Close') }}</button></div>
  </div></div>
</div>
@endsection
