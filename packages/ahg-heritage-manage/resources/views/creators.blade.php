...
<div class="row">  <div class="col-12">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1><i class="fas fa-users me-2"></i>Creators</h1>
      <a href="{{ route('heritage.landing') }}" class="btn btn-sm atom-btn-white"><i class="fas fa-home me-1"></i>Heritage Home</a>
    </div>
    <p class="text-muted">Browse heritage creators and authority records.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-users me-2"></i>Creators</div>
      <div class="card-body">
        @if(!empty($items))
