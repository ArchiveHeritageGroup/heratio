{{-- heratio#144 — Strongroom create/edit (single form, switches by $room being null or not) --}}
...
@section('content')
  ...
  <form method="post"
    ...
    <div class="mb-3">
      ...
      <input type="text" id="sr_name" name="name" class="form-control"
    ...
    <div class="mb-3">
      ...
      <textarea id="sr_location" name="location_description" class="form-control" rows="2"
                >{{ old('location_description', $room->location_description ?? '') }}</textarea>
    ...
    <div class="row g-3 mb-3">
      <div class="col-md-6">
        ...
        <input type="number" id="sr_capacity_value" name="capacity_value" class="form-control"
               min="0" step="0.01"
               value="{{ old('capacity_value', $room->capacity_value ?? '') }}">
    ...
    <div class="mb-4">
      ...
      <textarea id="sr_notes" name="notes" class="form-control" rows="4"
