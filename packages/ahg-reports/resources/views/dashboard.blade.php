...
<div class="sidebar-content">
    ...
    <ul class="list-unstyled small">
        ...
        @endif
        @if($hasResearch && \Illuminate\Support\Facades\Route::has('rdm.datasets.dashboard'))
        <li><a href="{{ route('rdm.datasets.dashboard') }}"><i class="fas fa-chart-line me-2"></i>{{ __('RDM Dashboard') }}</a></li>
        @endif
...
<div class="reports-dashboard">
  ...
  <div class="row mb-4">
    ...
    <div class="col-md-4">
      <div class="card h-100">
        <div class="card-header bg-secondary text-white"><h5 class="mb-0"><i class="fas fa-heartbeat me-2"></i>{{ __('Condition') }}</h5></div>
        <ul class="list-group list-group-flush">
      ...
      <div class="card h-100">
        ...
        <div class="card-footer bg-light">
          ...
          <div class="small text-center mt-2">
            ...
            - <a href="{{ Route::has('preservation.events') ? route('preservation.events') : url('/admin/preservation/events') }}">{{ number_format($stats['premis_events'] ?? 0) }} {{ __('PREMIS events') }}</a>,
