...
@section('title', 'Object Restrictions')

@section('content')
<h1>Object Restrictions</h1>
  ...
  <div class="accordion mb-3">
    <div class="accordion-item">
      <h2 class="accordion-header">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#main-collapse" aria-expanded="true">Object Restrictions</button>
      </h2>
