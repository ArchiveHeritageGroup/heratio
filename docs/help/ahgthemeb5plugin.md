...
The ahgThemeB5Plugin is a modern Bootstrap 5 theme for Access to Memory (Heratio), providing a contemporary UI framework that replaces the default arDominionB5Plugin theme. It features CSS custom properties for dynamic theming, an enhanced media player, multiple display modes, and a landing page builder.
