...
@section('title', 'Collections Procedure Reports Dashboard')
@section('body-class', 'admin spectrum-reports')
@section('sidebar')
<div class="sidebar-content">
  <h4>{{ __('Collections Procedure Reports') }}</h4>
...
@endsection
@section('title-block')<h1><i class="fas fa-clipboard-list me-2"></i>{{ __('Collections Procedure Reports Dashboard') }}</h1>@endsection
@section('content')
