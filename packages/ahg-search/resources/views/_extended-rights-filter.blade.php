...
<fieldset class="mb-3">
  ...
  <div class="row">
    <div class="col-md-4 mb-2">
      <label for="rights_statement_filter" class="form-label small">{{ __('Rights Statement') }} <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
    ...
    <div class="col-md-4 mb-2">
      <label for="cc_license_filter" class="form-label small">{{ __('CC License') }} <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
    ...
    <div class="col-md-4 mb-2">
      <label for="embargo_status_filter" class="form-label small">{{ __('Embargo Status') }} <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
