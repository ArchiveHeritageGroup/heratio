...
|---|---|---|
| `/etc/cron.d/ahg-discovery-prune` | minute 17 of every hour | `ahg:discovery-prune` against heratio + atom + archive DBs |
| `/etc/cron.d/ahg-facet-cache` | minute 0 of every hour | `ahg:refresh-facet-cache` against archive + atom + dam + heratio DBs |
| `/etc/cron.d/atom-backup` | daily 3am | shell script |
| `/etc/cron.d/atom-bot-watch` | weekly Mon 8am | shell script |
| `/etc/cron.d/mog-nas-backup` | per file | shell script |
| `/etc/cron.d/mysql-full-dump` | per file | shell script |
