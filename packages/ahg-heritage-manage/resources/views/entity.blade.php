...
<div class="row">  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-cube me-2"></i>Entity</div>
      <div class="card-body">
        @if(!empty($items))
