...
Plugin-specific controlled vocabulary system that replaces hardcoded dropdown values with database-driven terms. Stored in the `ahg_dropdown` table, separate from Heratio's core taxonomy system.
