...
@section('title', 'Analytics Alerts')
...
<div class="row">
  ...
  <div class="col-md-9">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1><i class="fas fa-bell me-2"></i>Analytics Alerts</h1>
      <div>
    ...
    <p class="text-muted">Monitor system alerts and anomalies.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-bell me-2"></i>Analytics Alerts Details</div>
      <div class="card-body">
        @if(!empty($records))
