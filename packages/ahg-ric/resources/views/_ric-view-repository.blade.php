...
<div class="ric-view">
  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="card mb-3">
        <div class="card-header" style="background:var(--ahg-primary);color:#fff">
          <i class="fas fa-users me-1"></i> {{ __('Related Agents') }}
        </div>
        <div class="list-group list-group-flush">
    ...
    <div class="col-md-4">
      <div class="card mb-3">
        ...
        <div class="card-body">
          ...
          <a href="/ric-api/relations/{{ $repository->id }}" class="btn btn-sm btn-outline-info w-100" target="_blank"><i class="fas fa-code me-1"></i>{{ __('View Relations JSON') }}</a>
        </div>
      </div>
    </div>
  </div>
