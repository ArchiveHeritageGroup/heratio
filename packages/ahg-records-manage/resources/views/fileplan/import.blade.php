        ...
        <form method="post" action="{{ route('records.fileplan.import.upload') }}" enctype="multipart/form-data" id="importForm">
            ...
            <div class="mb-3">
                ...
                <div>
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="type_spreadsheet">Excel / CSV</label>
                    </div>
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="type_directory">Directory Path</label>
                    </div>
                    <div class="form-check form-check-inline">
            ...
            <div id="directory-input-section" class="d-none">
                <div class="mb-3">
                    ...
                    <input type="text" name="directory_path" id="directory_path" class="form-control" value="{{ old('directory_path') }}" placeholder="/path/to/fileplan/directory">
            ...
            <div id="xml-format-section" class="d-none">
                <div class="mb-3">
                    <label for="xml_format" class="form-label">XML Format</label>
                    <select name="xml_format" id="xml_format" class="form-select">
                        <option value="generic" {{ old('xml_format', 'generic') === 'generic' ? 'selected' : '' }}>Generic XML</option>
                        <option value="ead" {{ old('xml_format') === 'ead' ? 'selected' : '' }}>EAD (Encoded Archival Description)</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="department" id="department" class="form-control" value="{{ old('department') }}" placeholder="e.g. Department of Home Affairs">
                </div>

                <div class="col-md-6 mb-3">
                    <label for="agency_code" class="form-label">Agency Code</label>
                    <input type="text" name="agency_code" id="agency_code" class="form-control" value="{{ old('agency_code') }}" maxlength="50" placeholder="e.g. DHA">
                </div>
            </div>

            <div class="d-flex justify-content-between">
                <a href="{{ route('records.fileplan.index') }}" class="btn btn-secondary">Cancel</a>
                <button type="submit" class="btn btn-primary">Next: Map Columns</button>
            </div>
        </form>
    </div>
</div>
