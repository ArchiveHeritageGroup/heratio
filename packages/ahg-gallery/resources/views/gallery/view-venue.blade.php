...
@section('content')
<div class="card"><div class="card-header" style="background-color:var(--ahg-card-header-bg, #005837);color:var(--ahg-card-header-text, #fff);"><h5 class="mb-0">Venue Details</h5></div>
...
@if($venue->notes ?? null)<h6>Notes</h6><p>{!! nl2br(e($venue->notes)) !!}</p>@endif
</div></div>
