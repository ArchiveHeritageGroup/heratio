...
@section('content')
  ...
  @php
    ...
    $addTile('AHG Central',           'fa-cloud',              'Connect to AHG Central for fleet monitoring, error-log sync, shared NER training and cloud AI features. Live at central.theahg.co.za; new installs auto-enrol.', 'settings.ahg-integration', 'primary', 'Configure', 'fa-cog');
