...
@section('content')
@auth<div class="mb-3"><a href="{{ route('gallery.loans.create') }}" class="btn atom-btn-white"><i class="fas fa-plus me-1"></i>Create Loan</a></div>@endauth
<div class="card">
  <div class="card-header" style="background-color:var(--ahg-card-header-bg, #005837);color:var(--ahg-card-header-text, #fff);"><h5 class="mb-0">Loan Records</h5></div>
  <div class="card-body p-0">
    @if(isset($loans) && count($loans) > 0)
    <table class="table table-striped table-hover mb-0"><thead><tr style="background-color:var(--ahg-card-header-bg, #005837);color:var(--ahg-card-header-text, #fff);"><th>Title</th><th>Type</th><th>Borrower/Lender</th><th>Start</th><th>End</th><th>Status</th><th>Actions</th></tr></thead>
