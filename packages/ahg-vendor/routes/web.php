...
Route::prefix('admin/vendor')->middleware(['web', 'auth'])->group(function () {
    ...
    Route::match(['get', 'post'], '/service-types', [\AhgVendor\Controllers\VendorController::class, 'serviceTypes'])->name('ahgvendor.service-types')->middleware('acl:update'); // whole match route gated (GET form + POST mutation share the route)
    ...
    Route::match(['get', 'post'], '/transactions/add', [\AhgVendor\Controllers\VendorController::class, 'addTransaction'])->name('ahgvendor.add-transaction')->middleware('acl:create'); // whole match route gated (GET form + POST mutation share the route)
    Route::match(['get', 'post'], '/transactions/{id}/edit', [\AhgVendor\Controllers\VendorController::class, 'editTransaction'])->name('ahgvendor.edit-transaction')->whereNumber('id')->middleware('acl:update'); // whole match route gated (GET form + POST mutation share the route)
    ...
    Route::match(['get', 'post'], '/add', [\AhgVendor\Controllers\VendorController::class, 'add'])->name('ahgvendor.add')->middleware('acl:create'); // whole match route gated (GET form + POST mutation share the route)
    Route::match(['get', 'post'], '/{slug}/edit', [\AhgVendor\Controllers\VendorController::class, 'edit'])->name('ahgvendor.edit')->middleware('acl:update'); // whole match route gated (GET form + POST mutation share the route)
