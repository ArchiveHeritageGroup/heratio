  ...
  <div class="container">
    ...
    @if(!empty($items))
      ...
      <nav class="mt-4"><ul class="pagination justify-content-center">
        @if(($page ?? 1) > 1)<li class="page-item"><a class="page-link" href="?category={{ $currentCategory['code'] }}&page={{ $page - 1 }}">{{ __('Previous') }}</a></li>@endif
        ...
        @if(($page ?? 1)<$totalPages)<li class="page-item"><a class="page-link" href="?category={{ $currentCategory['code'] }}&page={{ $page+1 }}">{{ __('Next') }}</a></li>@endif
      </ul></nav>
      @endif
    @else
