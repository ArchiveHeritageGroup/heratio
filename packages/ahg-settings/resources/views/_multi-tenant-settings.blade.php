...
<div class="card mb-4">
  ...
  <div class="card-body">
    <div class="form-check form-switch mb-3">
      ...
      <label class="form-check-label" for="tenant_enabled">Enable multi-tenancy <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
    </div>
    <div class="form-check form-switch mb-3">
      ...
      <label class="form-check-label" for="tenant_filter">Enforce tenant data isolation <span class="badge bg-secondary ms-1">{{ __('Recommended') }}</span></label>
    </div>
    <div class="form-check form-switch mb-3">
      ...
      <label class="form-check-label" for="tenant_switcher">Show tenant switcher in header <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
    </div>
    <div class="form-check form-switch mb-3">
      ...
      <label class="form-check-label" for="tenant_branding">Allow per-tenant branding <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
    </div>
  </div>
</div>
