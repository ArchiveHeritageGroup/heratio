...
@section('content')
<nav aria-label="{{ __('breadcrumb') }}"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="{{ route('research.dashboard') }}">Research</a></li><li class="breadcrumb-item active">Hypothesis</li></ol></nav>
...
<div class="card mb-4"><div class="card-header">Supporting Evidence</div><div class="card-body p-0">
    @if(!empty($evidence))
    <table class="table table-hover mb-0"><thead class="table-light"><tr><th>{{ __('Evidence') }}</th><th>{{ __('Source') }}</th><th>{{ __('Supports') }}</th></tr></thead><tbody>
