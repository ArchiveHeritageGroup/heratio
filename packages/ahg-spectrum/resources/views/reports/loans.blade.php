...
@section('content')
<h5>Loans In</h5>
<div class="table-responsive mb-4"><table class="table table-striped table-hover"><thead class="table-dark"><tr><th>Object</th><th>Lender</th><th>Start</th><th>End</th><th>Status</th></tr></thead><tbody>
...
<h5>Loans Out</h5>
<div class="table-responsive"><table class="table table-striped table-hover"><thead class="table-dark"><tr><th>Object</th><th>Borrower</th><th>Start</th><th>End</th><th>Status</th></tr></thead><tbody>
