...
Route::prefix('registry')->name('registry.')->group(function () {
    ...
    Route::get('/institution/{id}',          [RegistryController::class, 'institutionView'])->name('institutionView');
    Route::get('/institution/{id}/software', [RegistryController::class, 'institutionSoftware'])->name('institutionSoftware');
    Route::get('/institution/{id}/vendors',  [RegistryController::class, 'institutionVendors'])->name('institutionVendors');

    // Vendors
    Route::get('/vendors',                   [RegistryController::class, 'vendorBrowse'])->name('vendorBrowse');
    Route::get('/vendor/{id}',               [RegistryController::class, 'vendorView'])->name('vendorView');
    Route::get('/vendor/{id}/clients',       [RegistryController::class, 'vendorClients'])->name('vendorClients');

    // Software
    Route::get('/software',                  [RegistryController::class, 'softwareBrowse'])->name('softwareBrowse');
    Route::get('/software/{id}',             [RegistryController::class, 'softwareView'])->name('softwareView');
    Route::get('/software/{id}/releases',    [RegistryController::class, 'softwareReleases'])->name('softwareReleases');
    Route::get('/software/{id}/components',  [RegistryController::class, 'softwareComponents'])->name('softwareComponents');

    // Standards
    Route::get('/standards',                 [RegistryController::class, 'standardBrowse'])->name('standardBrowse');
    Route::get('/standard/{id}',             [RegistryController::class, 'standardView'])->name('standardView');
    ...
    Route::get('/group/{id}',                [RegistryController::class, 'groupView'])->name('groupView');
    Route::get('/group/{id}/members',        [RegistryController::class, 'groupMembers'])->name('groupMembers');
    ...
    Route::get('/discussion/{id}',           [RegistryController::class, 'discussionView'])->name('discussionView');

    // ERD
    Route::get('/erd',                       [RegistryController::class, 'erdBrowse'])->name('erdBrowse');
    Route::get('/erd/{id}',                  [RegistryController::class, 'erdView'])->name('erdView');

    // Setup guides
    Route::get('/setup-guides',              [RegistryController::class, 'setupGuideBrowse'])->name('setupGuideBrowse');
    Route::get('/setup-guide/{id}',          [RegistryController::class, 'setupGuideView'])->name('setupGuideView');

    // Newsletters
    Route::get('/newsletters',               [RegistryController::class, 'newsletterBrowse'])->name('newsletterBrowse');
    Route::get('/newsletter/{id}',           [RegistryController::class, 'newsletterView'])->name('newsletterView');
    ...
    // Instance
    Route::get('/instance/{id}',             [RegistryController::class, 'instanceView'])->name('instanceView');
...
Route::prefix('registry')->name('registry.')->middleware('auth')->group(function () {
    ...
    Route::get('/institution/{id}/edit',         [RegistryController::class, 'institutionEdit'])->name('institutionEdit');

    // Vendor management
    Route::get('/vendor/register',               [RegistryController::class, 'vendorRegister'])->name('vendorRegister');
    Route::get('/vendor/{id}/edit',              [RegistryController::class, 'vendorEdit'])->name('vendorEdit');
    Route::get('/vendor/{id}/client-form',       [RegistryController::class, 'vendorClientForm'])->name('vendorClientForm');
    Route::get('/vendor/{id}/software-manage',   [RegistryController::class, 'vendorSoftwareManage'])->name('vendorSoftwareManage');
    Route::get('/vendor/{id}/software-form',     [RegistryController::class, 'vendorSoftwareForm'])->name('vendorSoftwareForm');
    Route::get('/vendor/{id}/software-upload',   [RegistryController::class, 'vendorSoftwareUpload'])->name('vendorSoftwareUpload');
    Route::get('/vendor/{id}/release-manage',    [RegistryController::class, 'vendorReleaseManage'])->name('vendorReleaseManage');
    Route::get('/vendor/{id}/release-form',      [RegistryController::class, 'vendorReleaseForm'])->name('vendorReleaseForm');
    Route::get('/vendor/{id}/call-log-form',     [RegistryController::class, 'vendorCallLogForm'])->name('vendorCallLogForm');

    // Software component management
    Route::get('/software/{id}/component/add',            [RegistryController::class, 'softwareComponentAdd'])->name('softwareComponentAdd');
    Route::get('/software/{id}/component/{cid}/edit',     [RegistryController::class, 'softwareComponentEdit'])->name('softwareComponentEdit');

    // Group management
    Route::get('/group/create',                  [RegistryController::class, 'groupCreate'])->name('groupCreate');
    Route::get('/group/{id}/edit',               [RegistryController::class, 'groupEdit'])->name('groupEdit');
    Route::get('/group/{id}/members/manage',     [RegistryController::class, 'groupMembersManage'])->name('groupMembersManage');

    // Blog
    Route::get('/blog/new',                      [RegistryController::class, 'blogNew'])->name('blogNew');
    Route::get('/blog/{id}/edit',                [RegistryController::class, 'blogEdit'])->name('blogEdit');
    ...
    Route::get('/discussion/{id}/reply',         [RegistryController::class, 'discussionReply'])->name('discussionReply');
    ...
    Route::get('/my-institution/contact/{id}/edit', [RegistryController::class, 'myInstitutionContactEdit'])->name('myInstitutionContactEdit');
    ...
    Route::get('/my-institution/instance/{id}/edit', [RegistryController::class, 'myInstitutionInstanceEdit'])->name('myInstitutionInstanceEdit');
    ...
    Route::get('/my-vendor/contact/{id}/edit',   [RegistryController::class, 'myVendorContactEdit'])->name('myVendorContactEdit');
    ...
    Route::get('/my-vendor/software/{id}/edit',  [RegistryController::class, 'myVendorSoftwareEdit'])->name('myVendorSoftwareEdit');
    Route::get('/my-vendor/software/{id}/releases', [RegistryController::class, 'myVendorSoftwareReleases'])->name('myVendorSoftwareReleases');
    Route::get('/my-vendor/software/{id}/release/add', [RegistryController::class, 'myVendorSoftwareReleaseAdd'])->name('myVendorSoftwareReleaseAdd');
    Route::get('/my-vendor/software/{id}/upload', [RegistryController::class, 'myVendorSoftwareUpload'])->name('myVendorSoftwareUpload');
    Route::get('/my-vendor/call-log',            [RegistryController::class, 'myVendorCallLog'])->name('myVendorCallLog');
    Route::get('/my-vendor/call-log/{id}',       [RegistryController::class, 'myVendorCallLogView'])->name('myVendorCallLogView');
    ...
    Route::get('/instance/{id}/relink',          [RegistryController::class, 'instanceRelink'])->name('instanceRelink');
...
Route::prefix('registry/admin')->name('registry.admin.')->middleware('admin')->group(function () {
    ...
    Route::get('/user/{id}/edit',      [RegistryController::class, 'adminUserEdit'])->name('userEdit');
    Route::get('/user/{id}/manage',    [RegistryController::class, 'adminUserManage'])->name('userManage');
    Route::get('/groups',              [RegistryController::class, 'adminGroups'])->name('groups');
    Route::get('/group/{id}/edit',     [RegistryController::class, 'adminGroupEdit'])->name('groupEdit');
    Route::get('/group/{id}/members',  [RegistryController::class, 'adminGroupMembers'])->name('groupMembers');
    Route::get('/institutions',        [RegistryController::class, 'adminInstitutions'])->name('institutions');
    Route::get('/institution/{id}/users', [RegistryController::class, 'adminInstitutionUsers'])->name('institutionUsers');
    ...
    Route::get('/standard/{id}/edit',  [RegistryController::class, 'adminStandardEdit'])->name('standardEdit');
    Route::get('/dropdowns',           [RegistryController::class, 'adminDropdowns'])->name('dropdowns');
    Route::get('/dropdown/{id}/edit',  [RegistryController::class, 'adminDropdownEdit'])->name('dropdownEdit');
