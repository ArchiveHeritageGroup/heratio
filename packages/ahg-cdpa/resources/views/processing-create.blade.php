                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="category" class="form-select">
                                ...
                                <option value="hr">{{ __('HR/Employment') }}</option>
                                <option value="customer">{{ __('Customer Data') }}</option>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="storage_location" class="form-control" placeholder="{{ __('e.g., Local server, Cloud (AWS), Physical files') }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ __('International Transfer Country') }}</label>
                            <input type="text" name="international_country" class="form-control" placeholder="{{ __('If stored outside the local jurisdiction') }}">
                        </div>
                        <div class="col-12">
                            <label class="form-label">{{ __('Security Safeguards') }}</label>
                            <textarea name="safeguards" class="form-control" rows="2" placeholder="{{ __('e.g., Encryption, access controls, backups') }}"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="automated_decision">{{ __('Automated decision-making') }}</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-check">
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="health_data">{{ __('Health data') }}</label>
                            </div>
                        </div>
                        <div class="col-12" id="cross_border_safeguards_container" style="display:none;">
                            <label class="form-label">{{ __('Cross-border Safeguards') }}</label>
