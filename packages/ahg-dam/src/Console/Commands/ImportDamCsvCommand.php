...
/**
 * ImportDamCsvCommand - Artisan command for DAM CSV import.
 *
...
namespace AhgDam\Console\Commands;

use AhgDam\Services\DamCsvImporter;
use Illuminate\Console\Command;

class ImportDamCsvCommand extends Command
{
    protected $signature = 'sector:dam-csv-import
    ...
    protected $description = 'Import DAM CSV data with Dublin Core/IPTC validation';
    ...
    public function handle(): int
    {
        ...
        $this->info(sprintf('Processing %s for sector: dam (Dublin Core/IPTC)', basename($filename)));
    ...
    protected function runValidation(DamCsvImporter $importer, string $filename): int
    {
