...
@section('content')
  ...
  <form method="POST"
        ...
        <div id="collapseIdentification" class="accordion-collapse collapse show" aria-labelledby="headingIdentification" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The broad category of the work (e.g. Painting, Sculpture, Drawing).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">More specific object designation within the work type.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Systematic arrangement or categorization of the object.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The class or genre to which this object belongs.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">A broader category for grouping objects of similar type.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">A more specific sub-category within the object category.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The accession or catalogue number assigned to this object.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The type of catalogue record (e.g. item, group, volume).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Hierarchical level of this catalogue record.</div>
            </div>
        ...
        <div id="collapseTitle" class="accordion-collapse collapse" aria-labelledby="headingTitle" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              @enderror
              <div class="form-text">The primary name or title of the museum object. Required.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Any alternative, former, or translated titles for this object.</div>
            </div>
        ...
        <div id="collapseCreator" class="accordion-collapse collapse" aria-labelledby="headingCreator" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The name of the creator, artist, or maker of the object.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The role of the creator (e.g. artist, architect, designer, maker).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Part of the work created by this creator (e.g. design, frame, gilding).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Qualifier for the attribution (e.g. attributed to, circle of, studio of).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Full attribution statement for the creator.</div>
            </div>
        ...
        <div id="collapseCreation" class="accordion-collapse collapse" aria-labelledby="headingCreation" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The date of creation as displayed to users (free text, e.g. "circa 1650").</div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <div class="form-text">The earliest possible creation date for indexing.</div>
              </div>
              <div class="col-md-6 mb-3">
                ...
                <div class="form-text">The latest possible creation date for indexing.</div>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Qualifier for the date (e.g. circa, before, after, probably).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The geographic location where the object was created.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Type of place (e.g. country, city, region, site).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The location where the object was found or discovered.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Type of discovery place (e.g. archaeological site, tomb).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The artistic style (e.g. Baroque, Art Deco, Impressionist).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The historical period (e.g. Renaissance, Iron Age, Victorian).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The culture or people associated with the creation of this object.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The artistic movement (e.g. Cubism, Surrealism, Minimalism).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The school of art (e.g. Flemish School, Hudson River School).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The dynasty or ruling house (e.g. Ming, Tudor, Ottoman).</div>
            </div>
        ...
        <div id="collapseMeasurements" class="accordion-collapse collapse" aria-labelledby="headingMeasurements" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Overall measurements display (e.g. "72.4 x 91.4 cm").</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Structured dimensions (height, width, depth, weight, etc.).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Orientation of the object (e.g. portrait, landscape).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The shape of the object (e.g. rectangular, circular, irregular).</div>
            </div>
        ...
        <div id="collapseMaterials" class="accordion-collapse collapse" aria-labelledby="headingMaterials" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The materials and media used (e.g. oil on canvas, bronze, marble).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The techniques or processes used in creating the object.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Controlled term for the technique per CCO standard.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Qualifier for the technique (e.g. possibly, probably).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Description of how the object was made (brush strokes, casting marks, etc.).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Predominant colors of the object.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">General description of the physical appearance.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Summary of physical extent and medium.</div>
            </div>
        ...
        <div id="collapseSubject" class="accordion-collapse collapse" aria-labelledby="headingSubject" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Description of the content, subject matter, and iconography.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Combined style and period classification.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The cultural or social context of the object.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Type of subject term (e.g. description, identification, interpretation).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Display text for the subject of the work.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Part of the work to which the subject pertains.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Historical background or context for the object.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Architectural setting or context for the object.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Archaeological context (excavation site, stratigraphic layer, etc.).</div>
            </div>
        ...
        <div id="collapseEdition" class="accordion-collapse collapse" aria-labelledby="headingEdition" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Description of the edition (for prints, photographs, multiples).</div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <div class="form-text">Number of this impression within the edition.</div>
              </div>
              <div class="col-md-6 mb-3">
                ...
                <div class="form-text">Total number of impressions in the edition.</div>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Identification of the state (e.g. "State III of V").</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Description of changes made in this state.</div>
            </div>
        ...
        <div id="collapseInscriptions" class="accordion-collapse collapse" aria-labelledby="headingInscriptions" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Text of any inscriptions on the object.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Additional inscriptions not captured above.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Full transcription of the inscription text.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Type of inscription (e.g. signature, date, dedication, stamp).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Location of the inscription on the object (e.g. lower right, verso).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Language of the inscription.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Translation of the inscription if in a non-English language.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Type of mark (e.g. watermark, hallmark, collector's mark, brand).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Description of the mark.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Location of the mark on the object.</div>
            </div>
        ...
        <div id="collapseCondition" class="accordion-collapse collapse" aria-labelledby="headingCondition" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Controlled term for the condition (e.g. excellent, good, fair, poor).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Date of the condition assessment.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Detailed description of the current condition.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Additional notes on the condition.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Person who assessed the condition.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Type of conservation treatment performed.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Date the treatment was performed.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Person or organization that performed the treatment.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Detailed description of conservation treatment performed.</div>
            </div>
        ...
        <div id="collapseProvenance" class="accordion-collapse collapse" aria-labelledby="headingProvenance" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Ownership history of the object.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Full provenance narrative.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Detailed ownership history including dates and methods of transfer.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Where the object is currently stored or displayed.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The repository or institution where the object is currently held.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Geographic location of the repository.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">GPS coordinates (latitude, longitude).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Shelf, gallery, or storage reference number at the current location.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Legal status of the object (e.g. gift, purchase, loan, public domain).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Type of rights (e.g. copyright, trademark, public domain).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Person or institution holding the rights.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Date or range applicable to the rights statement.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Additional notes on rights and reproduction.</div>
            </div>
        ...
        <div id="collapseRelated" class="accordion-collapse collapse" aria-labelledby="headingRelated" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Type of the related work (e.g. part, copy, study, pendant).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Nature of the relationship (e.g. is part of, is copy of, is study for).</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Title or label of the related work.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Accession number or identifier of the related work.</div>
            </div>
        ...
        <div id="collapseCataloging" class="accordion-collapse collapse" aria-labelledby="headingCataloging" data-bs-parent="#museumAccordion">
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Name of the person who created or last updated this catalogue record.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Date this record was catalogued or last modified.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Institution responsible for creating this catalogue record.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Notes about the cataloging process or data quality.</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">The repository or institution holding this object.</div>
            </div>
    ...
    <div class="d-flex gap-2 mt-4 mb-4">
      <a href="{{ $isNew ? route('museum.browse') : route('museum.show', $museum->slug) }}" class="btn btn-secondary">
        Cancel
      </a>
