        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="node_type" id="node_type" class="form-select" required>
                        <option value="plan" {{ old('node_type') === 'plan' ? 'selected' : '' }}>Plan</option>
                        <option value="series" {{ old('node_type', 'series') === 'series' ? 'selected' : '' }}>Series</option>
                        <option value="sub_series" {{ old('node_type') === 'sub_series' ? 'selected' : '' }}>Sub-series</option>
                        <option value="file_group" {{ old('node_type') === 'file_group' ? 'selected' : '' }}>File Group</option>
                        <option value="volume" {{ old('node_type') === 'volume' ? 'selected' : '' }}>Volume</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="code" id="code" class="form-control" value="{{ old('code') }}" required maxlength="50" placeholder="e.g. 1/2/3">
                </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="disposal_class_id" id="disposal_class_id" class="form-control" value="{{ old('disposal_class_id') }}" placeholder="Disposal class ID">
                </div>

                <div class="col-md-4 mb-3">
                    <label for="retention_period" class="form-label">Retention Period</label>
                    <input type="text" name="retention_period" id="retention_period" class="form-control" value="{{ old('retention_period') }}" maxlength="100" placeholder="e.g. 5 years">
                </div>
