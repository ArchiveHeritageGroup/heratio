...
The ahgCartPlugin provides shopping cart and e-commerce functionality for Heratio, enabling both free reproduction requests and paid digital sales with PayFast payment integration.
...
- [AHG Framework Architecture](../Heratio_AHG_Framework_Library_Architecture_Diagrams.md)
