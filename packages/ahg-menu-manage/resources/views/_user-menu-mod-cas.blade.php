{{-- CAS user menu variant - ported from AtoM ahgThemeB5Plugin/modules/menu/templates/_userMenu.mod_cas.php --}}
...
<div class="dropdown my-2">
  ...
  <ul class="dropdown-menu dropdown-menu-lg-end mt-2" aria-labelledby="user-menu">
    ...
    <li><a class="dropdown-item" href="{{ route('cas.logout') }}">{{ __('Log out') }}</a></li>
  </ul>
</div>
@endif
