...
<div class="card-body"><div class="row">
  ...
  <div class="col-md-6 mb-3"><label for="loan_type" class="form-label">Loan Type <span class="badge bg-secondary ms-1">Optional</span></label><select name="loan_type" id="loan_type" class="form-select"><option value="incoming">Incoming</option><option value="outgoing">Outgoing</option></select></div>
