  ...
  <div class="card-body">
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="mb-3">
          <label class="form-label">Page size <span class="badge bg-secondary ms-1">Optional</span></label>
      ...
      <div class="col-md-6">
        <div class="mb-3">
          <label class="form-label">Max pages per PDF <span class="badge bg-secondary ms-1">Optional</span></label>
