...
@section('title', '3D Reports - Models')
@section('body-class', 'admin three-d-reports models')
@section('title-block')<h1 class="mb-0"><i class="fas fa-cube me-2"></i>3D Models</h1>@endsection
@section('content')
<div class="card"><div class="card-header" style="background-color:var(--ahg-card-header-bg, #005837);color:var(--ahg-card-header-text, #fff);"><h5 class="mb-0">Models</h5></div>
