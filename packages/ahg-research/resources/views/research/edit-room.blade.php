      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <input type="text" name="code" class="form-control" value="{{ e($room->code ?? '') }}" placeholder="e.g. RR-01">
            </div>
            <div class="col-md-6">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="location" class="form-control" value="{{ e($room->location ?? '') }}" placeholder="e.g. Building A, Floor 2">
          </div>
        ...
        <div class="col-md-6">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="days_open" class="form-control" value="{{ e($room->days_open ?? 'Mon,Tue,Wed,Thu,Fri') }}" placeholder="Mon,Tue,Wed,Thu,Fri">
            <small class="text-muted">Comma-separated list of days</small>
          </div>

          <h5 class="mb-3 mt-4 border-bottom pb-2">Additional Information</h5>

          <div class="mb-3">
            <label class="form-label">Amenities</label>
            <textarea name="amenities" class="form-control" rows="2" placeholder="WiFi, Power outlets, Lockers...">{{ e($room->amenities ?? '') }}</textarea>
          </div>

          <div class="mb-3">
            <label class="form-label">Rules</label>
            <textarea name="rules" class="form-control" rows="3" placeholder="No food or drinks, Handle materials with care...">{{ e($room->rules ?? '') }}</textarea>
          </div>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  <label class="form-label">Max Hours per Booking</label>
                ...
                <div class="col-md-4">
                  <label class="form-label">Cancellation Notice (hrs)</label>
