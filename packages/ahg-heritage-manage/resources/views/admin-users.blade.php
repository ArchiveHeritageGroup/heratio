...
<div class="row">
  ...
  <div class="col-md-9">
    ...
    <p class="text-muted">Manage heritage portal users and contributor accounts.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-users me-2"></i>Users</div>
      <div class="card-body">
