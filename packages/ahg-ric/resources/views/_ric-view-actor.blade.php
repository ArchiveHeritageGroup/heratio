    ...
    <div class="col-md-4">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          ...
          <a href="/ric-api/relations/{{ $actor->id }}" class="btn btn-sm btn-outline-info w-100 mb-2" target="_blank">
            <i class="fas fa-code me-1"></i>View Relations JSON
          </a>
          <a href="/ric-api/timeline/{{ $actor->id }}" class="btn btn-sm btn-outline-secondary w-100" target="_blank">
