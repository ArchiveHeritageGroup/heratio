...
@section('right')
  ...
  @php
    $__attTiles = (isset($artwork) && $artwork && \AhgCore\Services\AttachedDigitalObjectService::available())
        ? app(\AhgCore\Services\AttachedDigitalObjectService::class)->listFor((int) $artwork->id)
        : collect();
  @endphp
