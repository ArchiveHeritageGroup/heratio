{{--
  ...
  Cloned from AtoM ahgPrivacyPlugin/modules/privacyAdmin/templates/indexSuccess
...
@section('title', __('Privacy Compliance'))
...
<div class="container-fluid py-4">
    ...
    <div class="alert alert-primary d-flex align-items-center mb-4">
        ...
        <a href="{{ route('ahgspectrum.privacy-admin') }}" class="btn btn-primary btn-sm">
    ...
    <div class="alert alert-warning d-flex align-items-center mb-4">
        ...
        <a href="{{ route('ahgspectrum.privacy-admin') }}" class="btn btn-warning btn-sm">
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card h-100 border-primary">
                ...
                <div class="card-footer bg-transparent">
                    <a href="{{ route('ahgspectrum.privacy-dsar', ['jurisdiction' => $currentJurisdiction]) }}" class="text-primary">
        ...
        <div class="col-md-3">
            <div class="card h-100 border-danger">
                ...
                <div class="card-footer bg-transparent">
                    <a href="{{ route('ahgspectrum.privacy-breaches', ['jurisdiction' => $currentJurisdiction]) }}" class="text-danger">
                        {{ __('View all') }} <i class="fas fa-arrow-right ms-1"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card h-100 border-success">
                ...
                <div class="card-footer bg-transparent">
                    <a href="{{ route('ahgspectrum.privacy-ropa', ['jurisdiction' => $currentJurisdiction]) }}" class="text-success">
                        {{ __('View all') }} <i class="fas fa-arrow-right ms-1"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card h-100 border-info">
                ...
                <div class="card-footer bg-transparent">
                    <a href="{{ route('ahgspectrum.privacy-admin') }}" class="text-info">
                        {{ __('View all') }} <i class="fas fa-arrow-right ms-1"></i>
                    </a>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ route('ahgspectrum.privacy-dsar') }}" class="btn btn-outline-primary btn-lg w-100">
                                <i class="fas fa-plus-circle d-block mb-2 fa-2x"></i>
                                {{ __('New DSAR') }}
                            </a>
                        </div>
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ route('ahgspectrum.privacy-breaches') }}" class="btn btn-outline-danger btn-lg w-100">
                                <i class="fas fa-exclamation-triangle d-block mb-2 fa-2x"></i>
                                {{ __('Report Breach') }}
                            </a>
                        </div>
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ route('ahgspectrum.privacy-ropa') }}" class="btn btn-outline-success btn-lg w-100">
                        ...
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ route('ahgspectrum.privacy-admin') }}" class="btn btn-outline-warning btn-lg w-100">
                        ...
                        @endif
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ route('ahgspectrum.privacy-admin') }}" class="btn btn-outline-secondary btn-lg w-100">
                        ...
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ route('ahgspectrum.privacy-admin') }}" class="btn btn-outline-info btn-lg w-100">
                                <i class="fas fa-globe d-block mb-2 fa-2x"></i>
                                {{ __('Jurisdictions') }}
                            </a>
                        </div>
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ route('ahgspectrum.privacy-templates') }}" class="btn btn-outline-dark btn-lg w-100">
