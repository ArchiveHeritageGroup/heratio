...
<div class="row">
  ...
  <div class="col-md-9">
    <h1><i class="fas fa-dollar-sign me-2"></i>{{ __('Add Valuation') }}</h1>
    ...
    <form method="post" action="{{ $formAction ?? '#' }}">
      ...
      <div class="card mb-3">
        <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-dollar-sign me-2"></i>{{ __('Add Valuation') }}</div>
        <div class="card-body">
