  ...
  <section class="section border-bottom" id="contextArea">
    ...
    <div id="context-collapse">
      ...
      @if($function->legislation)
        <div class="field row g-0">
          <h3 class="h6 lh-base m-0 text-muted col-3 border-end text-end p-2">{{ __('Legislation') }}</h3>
    ...
    <div id="relationships-collapse">
        ...
        @foreach($relatedFunctions as $related)
          <div class="field row g-0">
            ...
            <div class="col-9 p-2">
              <div class="ms-2">
                <div class="field row g-0">
                  <h3 class="h6 lh-base m-0 text-muted col-4 border-end text-end p-1 small">{{ __('Authorized form of name') }}</h3>
                ...
                @if($related->description_identifier ?? null)
                  <div class="field row g-0">
                    <h3 class="h6 lh-base m-0 text-muted col-4 border-end text-end p-1 small">{{ __('Identifier') }}</h3>
                    <div class="col-8 p-1">{{ $related->description_identifier }}</div>
                  </div>
                @endif
                @if($related->type_name ?? null)
                  <div class="field row g-0">
                    <h3 class="h6 lh-base m-0 text-muted col-4 border-end text-end p-1 small">{{ __('Type') }}</h3>
                    <div class="col-8 p-1">{{ $related->type_name }}</div>
                  </div>
                @endif
                @if($related->relation_type ?? null)
                  <div class="field row g-0">
                    <h3 class="h6 lh-base m-0 text-muted col-4 border-end text-end p-1 small">{{ __('Category of relationship') }}</h3>
                    <div class="col-8 p-1">{{ $related->relation_type }}</div>
                  </div>
                @endif
                @if($related->relation_description ?? null)
                  <div class="field row g-0">
                    <h3 class="h6 lh-base m-0 text-muted col-4 border-end text-end p-1 small">{{ __('Description of relationship') }}</h3>
                    <div class="col-8 p-1">{!! nl2br(e($related->relation_description)) !!}</div>
                  </div>
                @endif
                @if($related->relation_dates ?? null)
                  <div class="field row g-0">
                    <h3 class="h6 lh-base m-0 text-muted col-4 border-end text-end p-1 small">{{ __('Dates of relationship') }}</h3>
      ...
      @if(isset($relatedActors) && count($relatedActors) > 0)
        @foreach($relatedActors as $actor)
          <div class="field row g-0">
            <h3 class="h6 lh-base m-0 text-muted col-3 border-end text-end p-2">{{ __('Related authority record') }}</h3>
            <div class="col-9 p-2">
              <div class="ms-2">
                <div class="field row g-0">
                  <h3 class="h6 lh-base m-0 text-muted col-4 border-end text-end p-1 small">{{ __('Authorized form of name') }}</h3>
                ...
                @if($actor->relation_description ?? null)
                  <div class="field row g-0">
                    <h3 class="h6 lh-base m-0 text-muted col-4 border-end text-end p-1 small">{{ __('Nature of relationship') }}</h3>
                    <div class="col-8 p-1">{!! nl2br(e($actor->relation_description)) !!}</div>
                  </div>
                @endif
                @if($actor->relation_dates ?? null)
                  <div class="field row g-0">
                    <h3 class="h6 lh-base m-0 text-muted col-4 border-end text-end p-1 small">{{ __('Dates of the relationship') }}</h3>
      ...
      @if(isset($relatedResources) && $relatedResources->isNotEmpty())
        @foreach($relatedResources as $resource)
          <div class="field row g-0">
            <h3 class="h6 lh-base m-0 text-muted col-3 border-end text-end p-2">{{ __('Related resource') }}</h3>
            <div class="col-9 p-2">
              <div class="ms-2">
                <div class="field row g-0">
                  <h3 class="h6 lh-base m-0 text-muted col-4 border-end text-end p-1 small">{{ __('Title') }}</h3>
  ...
  <section class="section border-bottom" id="controlArea">
    ...
    <div id="control-collapse">
      ...
      @if($function->revision_history)
        <div class="field row g-0">
          <h3 class="h6 lh-base m-0 text-muted col-3 border-end text-end p-2">{{ __('Dates of creation, revision or deletion') }}</h3>
      ...
      @if(isset($maintenanceNote) && $maintenanceNote)
        <div class="field row g-0">
          <h3 class="h6 lh-base m-0 text-muted col-3 border-end text-end p-2">{{ __('Maintenance notes') }}</h3>
