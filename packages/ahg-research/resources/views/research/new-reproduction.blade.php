...
<div class="card"><div class="card-body">
    <form method="POST">@csrf
        <div class="mb-3"><label class="form-label">Item Reference <span class="text-danger">*</span> <span class="badge bg-danger ms-1">Required</span></label><input type="text" name="item_reference" class="form-control" required placeholder="Enter item identifier or title"></div>
        <div class="row mb-3">
            ...
            <div class="col-md-3"><label class="form-label">Format <span class="badge bg-danger ms-1">Required</span></label><select name="format" class="form-select"><option value="pdf">PDF</option><option value="tiff">TIFF</option><option value="jpeg">JPEG</option><option value="paper">Paper</option></select></div>
