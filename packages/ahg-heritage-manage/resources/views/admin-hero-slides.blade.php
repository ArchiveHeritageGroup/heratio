      ...
      <div class="card-body">
        <form action="{{ route('heritage.admin-hero-slides') }}" method="post" enctype="multipart/form-data">@csrf
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              <div class="mb-3"><label for="title" class="form-label">Title <span class="badge bg-secondary ms-1">Optional</span></label><input type="text" class="form-control" name="title" value="{{ $editSlideData['title'] ?? '' }}" placeholder="{{ __('Slide title (optional)') }}"></div>
              ...
              <div class="mb-3"><label for="image_alt" class="form-label">Image Alt Text <span class="badge bg-secondary ms-1">Optional</span></label><input type="text" class="form-control" name="image_alt" value="{{ $editSlideData['image_alt'] ?? '' }}" placeholder="{{ __('Describe the image for accessibility') }}"></div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-4 mb-3"><label class="form-label">Button Text <span class="badge bg-secondary ms-1">Optional</span></label><input type="text" class="form-control" name="cta_text" value="{{ $editSlideData['cta_text'] ?? '' }}" placeholder="{{ __('e.g., Explore Collection') }}"></div>
