...
<div class="row">
  ...
  <div class="col-md-9">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1><i class="fas fa-eye me-2"></i>{{ __('View Report') }}</h1>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-eye me-2"></i>{{ __('View Report') }}</div>
      <div class="card-body">
        @if(isset($report))
