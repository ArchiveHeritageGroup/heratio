...
@section('title', 'Authority Functions')
@section('body-class', 'browse')
@section('content')
  <div class="multiline-header d-flex align-items-center mb-3">
    <i class="fas fa-3x fa-sitemap me-3" aria-hidden="true"></i>
    <div class="d-flex flex-column"><h1 class="mb-0">Authority Functions</h1></div>
  </div>
  @if(isset($rows) && count($rows))
    <div class="table-responsive"><table class="table table-bordered table-hover mb-0">
      <thead><tr style="background:var(--ahg-primary);color:#fff"><th>#</th><th>Authority</th><th>Function</th><th>Type</th><th>Date Range</th></tr></thead>
