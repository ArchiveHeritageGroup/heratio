...
@section('title', 'Register as Contributor')
@section('body-class', 'heritage')

@section('content')
<div class="row">  <div class="col-12">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1><i class="fas fa-user-plus me-2"></i>Register as Contributor</h1>
      <a href="{{ route('heritage.landing') }}" class="btn btn-sm atom-btn-white"><i class="fas fa-home me-1"></i>Heritage Home</a>
    </div>
    <p class="text-muted">Create a new contributor account.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-user-plus me-2"></i>Register as Contributor</div>
      <div class="card-body">
        @if(!empty($items))
