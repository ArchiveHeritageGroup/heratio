{{-- External auth user edit variant - ported from AtoM ahgThemeB5Plugin/modules/user/templates/editSuccess.mod_ext_auth.php --}}
{{-- Ext-auth users cannot change username/password, only groups + access control --}}
{{-- Identical to CAS variant (both strip password fields) --}}
