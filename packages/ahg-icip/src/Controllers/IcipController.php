...
class IcipController extends Controller
{
    ...
    {
        // #1427 - the graded ICIP access decision now lives in a single shared
        // service (IcipAccessService) so the archival show page and any other
        // surface can consult the exact same logic without duplicating it.
