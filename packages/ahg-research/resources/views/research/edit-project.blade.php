...
<div class="card">
    <div class="card-body">
        <form method="POST">
            @csrf
            <div class="row mb-3">
                <div class="col-md-8"><label class="form-label">Title <span class="text-danger">*</span> <span class="badge bg-danger ms-1">Required</span></label><input type="text" name="title" class="form-control" required value="{{ e($project->title ?? '') }}"></div>
                <div class="col-md-4"><label class="form-label">Type <span class="badge bg-secondary ms-1">Optional</span></label>
            ...
            <div class="mb-3"><label class="form-label">Description <span class="badge bg-secondary ms-1">Optional</span></label><textarea name="description" class="form-control" rows="4">{{ e($project->description ?? '') }}</textarea></div>
            <div class="row mb-3">
                <div class="col-md-4"><label class="form-label">Status <span class="badge bg-secondary ms-1">Optional</span></label>
                ...
                <div class="col-md-4"><label class="form-label">Start Date <span class="badge bg-secondary ms-1">Optional</span></label><input type="date" name="start_date" class="form-control" value="{{ $project->start_date ?? '' }}"></div>
                <div class="col-md-4"><label class="form-label">End Date <span class="badge bg-secondary ms-1">Optional</span></label><input type="date" name="end_date" class="form-control" value="{{ $project->end_date ?? '' }}"></div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6"><label class="form-label">Institution <span class="badge bg-secondary ms-1">Optional</span></label>
                ...
                <div class="col-md-6"><label class="form-label">Visibility <span class="badge bg-secondary ms-1">Optional</span></label>
