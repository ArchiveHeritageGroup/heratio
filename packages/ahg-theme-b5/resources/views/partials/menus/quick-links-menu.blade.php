...
<li class="nav-item dropdown d-flex flex-column">
  ...
  <ul class="dropdown-menu dropdown-menu-end mb-2" aria-labelledby="quick-links-menu">
    ...
    <li><a class="dropdown-item" href="{{ url('/about') }}"><i class="fas fa-info-circle fa-fw me-2"></i>{{ __('About') }}</a></li>
    <li><a class="dropdown-item" href="{{ url('/contact') }}"><i class="fas fa-envelope fa-fw me-2"></i>{{ __('Contact') }}</a></li>
  </ul>
</li>
