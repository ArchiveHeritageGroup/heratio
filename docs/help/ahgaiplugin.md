...
Consolidated AI-powered tools plugin for Heratio providing Named Entity Recognition (NER), Translation, Summarization, Spellcheck, Handwriting Text Recognition (HTR), and **LLM-powered Description Suggestions**. This plugin consolidates previously separate NER and Translation plugins into a unified AI tools suite.
...
-- Entity linking to Heratio actors
