...
@endsection
@section('title-block')
  <h1><i class="fas fa-shield-alt me-2"></i>Security</h1>
  <p class="text-muted small mb-0">Security lockout and password policies</p>
@endsection
@section('content')
  @if(session('success'))
  ...
  <form method="post" action="{{ route('settings.ahg.security') }}">
    ...
    @endphp
    <div class="card mb-4">
      <div class="card-header"><h5 class="mb-0"><i class="fas fa-shield-alt me-2"></i>Security</h5></div>
      <div class="card-body">
