...
class PronomIdentificationService
{
    ...
    public const MAGIC_SIGNATURES = [
        ...
        // 3D models (#1179). glTF PUIDs confirmed in PRONOM: fmt/1315 (Text/.gltf)
        // and fmt/1316 (Binary/.glb). OBJ/PLY/STL: fmt/1210, fmt/831, x-fmt/108.
        ['puid' => 'fmt/1316', 'name' => 'GL Transmission Format (Binary)',       'version' => '2.0', 'ext' => 'glb', 'mime' => 'model/gltf-binary',       'offset' => 0, 'hex' => '676c5446',           'risk' => 'medium', 'is_preservation' => false],
    ...
    public const EXTENSION_MAP = [
        ...
        ['puid' => 'fmt/1315', 'name' => 'GL Transmission Format (Text)',         'version' => '2.0', 'ext' => 'gltf', 'mime' => 'model/gltf+json',   'risk' => 'medium', 'is_preservation' => false],
        ['puid' => 'fmt/865',  'name' => 'STL (Binary)',                         'version' => null,  'ext' => 'stl',  'mime' => 'model/stl',         'risk' => 'low',    'is_preservation' => true],
        ['puid' => 'fmt/1316', 'name' => 'GL Transmission Format (Binary)',       'version' => '2.0', 'ext' => 'glb',  'mime' => 'model/gltf-binary', 'risk' => 'medium', 'is_preservation' => false],
