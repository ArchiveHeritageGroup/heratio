...
<div class="row">  <div class="col-md-3">@include('ahg-heritage-manage::partials._admin-sidebar')</div>
  <div class="col-md-9">
    ...
    <p class="text-muted">Top contributors to the heritage portal.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-trophy me-2"></i>Leaderboard</div>
      <div class="card-body">
        @if(!empty($items))
