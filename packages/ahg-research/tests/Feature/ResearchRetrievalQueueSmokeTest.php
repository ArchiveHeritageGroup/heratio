...
class ResearchRetrievalQueueSmokeTest extends TestCase
{
    ...
    // The retrievalQueue route lives in the admin-gated group (middleware('admin')
    ...
    {
        $response = $this->post('/research/retrievalQueue', [
