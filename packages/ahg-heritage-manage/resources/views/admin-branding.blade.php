...
<div class="row">
  ...
  <div class="col-md-9">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1><i class="fas fa-palette me-2"></i>Branding</h1>
    </div>
    <p class="text-muted">Configure heritage portal branding, colors, and logos.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-palette me-2"></i>Branding</div>
      <div class="card-body">
