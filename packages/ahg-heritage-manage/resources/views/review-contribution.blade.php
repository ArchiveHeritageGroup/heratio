...
@section('content')
<div class="row">  <div class="col-md-3">@include('ahg-heritage-manage::partials._admin-sidebar')</div>
  <div class="col-md-9">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1><i class="fas fa-check-square me-2"></i>Review Contribution</h1>
      <a href="{{ route('heritage.landing') }}" class="btn btn-sm atom-btn-white"><i class="fas fa-home me-1"></i>Heritage Home</a>
    </div>
    <p class="text-muted">Review a submitted contribution.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-check-square me-2"></i>Review Contribution</div>
      <div class="card-body">
        @if(!empty($items))
