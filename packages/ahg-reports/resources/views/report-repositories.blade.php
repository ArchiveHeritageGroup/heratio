...
<div class="row">
  <div class="col-md-3">
    ...
    @include('ahg-reports::_filters', ['action' => route('reports.repositories')])
  </div>
  <div class="col-md-9">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1><i class="fas fa-university me-2"></i>Repository Report</h1>
      <div>
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-striped table-sm">
        <thead><tr><th>ID</th><th>Identifier</th><th>Name</th><th>Holdings</th><th>Created</th><th>Updated</th></tr></thead>
        <tbody>
          @forelse($results as $row)
            <tr>
              ...
              <td><span class="badge bg-info">{{ $row->holdings_count ?? 0 }}</span></td>
