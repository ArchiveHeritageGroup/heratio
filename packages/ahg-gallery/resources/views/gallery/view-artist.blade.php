...
@section('content')
<div class="card"><div class="card-header" style="background-color:var(--ahg-card-header-bg, #005837);color:var(--ahg-card-header-text, #fff);"><h5 class="mb-0">Artist Details</h5></div>
...
@if($artist->biography ?? null)<h6 class="mt-3">Biography</h6><p>{!! nl2br(e($artist->biography)) !!}</p>@endif
</div></div>
@endsection
