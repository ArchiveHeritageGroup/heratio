...
@section('content')
  ...
  <div class="card-body"><form method="POST" action="{{ $formAction ?? '#' }}">@csrf
    <div class="mb-3"><label class="form-label">Object IDs <span class="badge bg-secondary">field</span></label><textarea class="form-control" name="object_ids" rows="4" placeholder="One ID per line"></textarea></div>
