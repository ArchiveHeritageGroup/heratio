...
│                                                                         │
│  ┌─────────────────────────────────────────────────────────────────┐   │
│  │              Heratio 2.10 PRESENTATION LAYER                        │   │
...
│  ─────────────────────────          │  ───────────────────────         │
│                                     │                                   │
│  • Core Heratio entities:              │  • Extension tables:              │
...
│    - Maintains Heratio compatibility   │    - Modern fluent syntax         │
...
│  ROUTING (Preserved)                                                    │
│  ─────────────────                                                      │
│  • All core Heratio routes work unchanged                                  │
