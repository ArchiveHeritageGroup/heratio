...
# Heratio AHG Framework - Architecture Diagrams
...
Shows the three-layer structure: Heratio Base, atom-framework, atom-ahg-plugins
...
flowchart TB
    ...
    subgraph ATOMBASE["Heratio 2.10 BASE Symfony 1.x"]
        direction TB
        FRONT["index.php"]
    ...
    subgraph DATABASE["MySQL Database"]
        ATOMTABLES[("Core Heratio Tables")]
...
flowchart TB
    ...
    subgraph ATOMROUTING["Heratio Routing Layer"]
...
flowchart LR
    subgraph ROOT["usr share nginx archive"]
        direction TB
        subgraph ATOMCORE["Heratio Core"]
            INDEX["index.php"]
...
flowchart TB
    ...
    subgraph PROPELPATH["PROPEL ORM PATH for Heratio Core Data"]
        direction TB
    ...
    subgraph MYSQL["MySQL Database"]
        subgraph CORETABLES["Core Heratio Tables"]
            TOBJ[("object")]
    ...
    REQ -->|"Heratio entities"| PROPELPATH
...
| Path | Use For |
|------|---------|
| **Propel ORM** | QubitInformationObject, Actor, ACL, Core Heratio queries |
...
|-----------|------------|---------|
| Core Heratio | Symfony 1.x + Propel | Legacy base system |
