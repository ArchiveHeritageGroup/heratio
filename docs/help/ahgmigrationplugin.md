...
Universal data migration tool with sector-based field mapping for importing data from external collection management systems into Heratio. Supports Vernon CMS, ArchivesSpace, DB/TextWorks, PastPerfect, CollectiveAccess, EAD files, and custom CSV/XML formats.
...
class EadParser implements ParserInterface
{
    ...
    // Maps standard EAD elements to Heratio fields
