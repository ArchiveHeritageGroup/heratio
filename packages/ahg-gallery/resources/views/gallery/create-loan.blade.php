...
<div class="card-body"><div class="row">
  ...
  <div class="col-md-3 mb-3"><label for="end_date" class="form-label">End Date <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label><input type="date" name="end_date" id="end_date" class="form-control"></div>
  <div class="col-md-6 mb-3"><label for="insurance_value" class="form-label">Insurance Value (R) <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label><input type="number" name="insurance_value" id="insurance_value" class="form-control" step="0.01"></div>
  <div class="col-md-6 mb-3"><label for="loan_fee" class="form-label">Loan Fee (R) <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label><input type="number" name="loan_fee" id="loan_fee" class="form-control" step="0.01"></div>
  <div class="col-12 mb-3"><label for="conditions" class="form-label">Conditions <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label><textarea name="conditions" id="conditions" class="form-control" rows="3"></textarea></div>
