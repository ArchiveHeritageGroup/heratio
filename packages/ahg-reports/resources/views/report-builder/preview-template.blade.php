...
<div class="row">
  ...
  <div class="col-md-9">
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-search me-2"></i>{{ __('Preview Template') }}</div>
      <div class="card-body">
        @if(isset($report))
