...
@section('title', 'National Treasury Report')
...
<div class="row">
  ...
  <div class="col-md-9">
    <h1><i class="fas fa-file-alt me-2"></i>National Treasury Report</h1>
    <p class="text-muted">Generate National Treasury GRAP 103 compliance report.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-file-alt me-2"></i>National Treasury Report</div>
      <div class="card-body">
        @if(!empty($items))
