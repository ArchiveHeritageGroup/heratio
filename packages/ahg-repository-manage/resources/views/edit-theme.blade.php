    ...
    <div class="accordion mb-3">
      <div class="accordion-item">
        ...
        <div id="style-collapse" class="accordion-collapse collapse" aria-labelledby="style-heading">
          <div class="accordion-body">
            <div class="mb-3">
              <label for="backgroundColor" class="form-label">{{ __('Background color') }} <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
            ...
            <div class="mb-3">
              <label for="banner" class="form-label">{{ __('Banner') }} <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
            ...
            <div class="mb-3">
              <label for="logo" class="form-label">{{ __('Logo') }} <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
      ...
      <div class="accordion-item">
        ...
        <div id="content-collapse" class="accordion-collapse collapse" aria-labelledby="content-heading">
          <div class="accordion-body">
            <div class="mb-3">
              <label for="htmlSnippet" class="form-label">{{ __('Description') }} <span class="badge bg-secondary ms-1">{{ __('Optional') }}</span></label>
