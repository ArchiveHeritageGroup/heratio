...
@section('title-block')
  <div class="multiline-header d-flex align-items-center mb-3">
    ...
    <div class="d-flex flex-column"><h1 class="mb-0">{{ __('Legal Holds') }}</h1><span class="small text-muted">{{ __('Digital object integrity management') }}</span></div>
  </div>
@endsection
@section('content')
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="{{ route('integrity.holds.create') }}" class="btn btn-sm btn-success"><i class="fas fa-plus me-1"></i>{{ __('Place Hold') }}</a>
</div>
