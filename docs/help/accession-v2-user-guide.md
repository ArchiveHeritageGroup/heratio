...
Accession Management V2 provides a comprehensive accession lifecycle management system for GLAM institutions. It extends the standard Heratio accession records with:
