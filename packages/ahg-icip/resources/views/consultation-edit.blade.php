...
<div class="container-xxl">
  ...
  <form method="post" class="needs-validation" novalidate>
    ...
    <div class="row">
      <div class="col-lg-8">
        <div class="card mb-4">
          <div class="card-header"><h5 class="mb-0">{{ __('Consultation Details') }}</h5></div>
          <div class="card-body">
            <div class="row">
        ...
        <div class="card mb-4">
          <div class="card-header"><h5 class="mb-0">{{ __('Attendees') }}</h5></div>
          <div class="card-body">
            <div class="mb-3">
              <label class="form-label">{{ __('Community Representatives') }}</label>
              <textarea name="community_representatives" class="form-control" rows="2" placeholder="{{ __('Names of community members present') }}">{{ $consultation->community_representatives ?? '' }}</textarea>
            </div>
            <div class="mb-3">
              <label class="form-label">{{ __('Institution Representatives') }}</label>
              <textarea name="institution_representatives" class="form-control" rows="2" placeholder="{{ __('Names of institution staff present') }}">{{ $consultation->institution_representatives ?? '' }}</textarea>
            </div>
            <div class="mb-3">
              <label class="form-label">{{ __('Other Attendees') }}</label>
              <textarea name="attendees" class="form-control" rows="2" placeholder="{{ __('Any other attendees') }}">{{ $consultation->attendees ?? '' }}</textarea>
            </div>
          </div>
        </div>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              <label class="form-label">{{ __('Outcomes') }}</label>
              <textarea name="outcomes" class="form-control" rows="4" placeholder="{{ __('What was decided or agreed upon...') }}">{{ $consultation->outcomes ?? '' }}</textarea>
            </div>
          </div>
        </div>

        <div class="card mb-4">
          <div class="card-header"><h5 class="mb-0">{{ __('Follow-up') }}</h5></div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6 mb-3">
            ...
            <div class="mb-3">
              <label class="form-label">{{ __('Follow-up Notes') }}</label>
              <textarea name="follow_up_notes" class="form-control" rows="3" placeholder="{{ __('What needs to happen next...') }}">{{ $consultation->follow_up_notes ?? '' }}</textarea>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="card mb-4">
          <div class="card-header"><h6 class="mb-0">{{ __('Confidentiality') }}</h6></div>
          <div class="card-body">
