...
@section('content')
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="{{ route('workflow.gates.admin') }}" class="btn atom-btn-white"><i class="fas fa-arrow-left"></i> Back</a>
  </div>
    ...
    <div class="card-body">
      <form action="{{ route('workflow.gates.edit', $rule->id ?? null) }}" method="POST">
        ...
        <div class="row">
          <div class="col-md-8">
            <div class="mb-3">
              <label for="name" class="form-label">Rule Name <span class="text-danger">*</span> <span class="badge bg-danger ms-1">Required</span></label>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="mb-3">
              <label for="rule_type" class="form-label">Rule Type <span class="text-danger">*</span> <span class="badge bg-danger ms-1">Required</span></label>
          ...
          <div class="col-md-4">
            <div class="mb-3">
              <label for="entity_type" class="form-label">Entity Type <span class="badge bg-secondary ms-1">Optional</span></label>
          ...
          <div class="col-md-4">
            <div class="mb-3">
              <label for="severity" class="form-label">Severity <span class="text-danger">*</span> <span class="badge bg-danger ms-1">Required</span></label>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="mb-3">
              <label for="rule_config" class="form-label">Rule Configuration (JSON) <span class="badge bg-secondary ms-1">Optional</span></label>
        ...
        <div class="mb-3">
          <label for="error_message" class="form-label">Error Message <span class="text-danger">*</span> <span class="badge bg-danger ms-1">Required</span></label>
