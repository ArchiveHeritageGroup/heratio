{{--
  DACS field set - #1425 dynamic-standard form. Field accordion only (no <form>,
  no save, no display-standard dropdown - the host owns those). Rendered by
  dacs-manage::edit and swapped into the create/edit form on standard change.
  Nullable $io: empty on create, populated on edit.
--}}
@php
  $io = $io ?? (object) [];
...
<input type="hidden" name="_display_standard_code" value="dacs">
