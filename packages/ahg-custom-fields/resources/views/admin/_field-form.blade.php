...
<form id="cf-definition-form" method="post" action="{{ route('customFields.save') }}">
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="mb-3">
                <label for="cf-machine-name" class="form-label">Machine Name <span class="text-danger">*</span></label>
            ...
            <div class="mb-3">
                <label for="cf-options" class="form-label">Options (for dropdown/multi-select)</label>
