  ...
  <div class="row g-3 mb-4">
    ...
    <div class="col-md-5">
      <div class="card h-100">
        ...
        <div class="card-body">
          @if($capacity !== null)
            <div class="progress mb-2" role="progressbar" aria-valuenow="{{ $pct }}" aria-valuemin="0" aria-valuemax="100" style="height: 1.5rem;">
          ...
          @else
            <p class="text-muted mb-0">{{ __('No capacity set for this strongroom.') }}
              @auth <a href="{{ route('strongroom.edit', ['slug' => $room->slug]) }}">{{ __('Set one') }}</a>. @endauth
            </p>
          @endif
        </div>
      </div>
