...
@section('title', 'Taxonomy ACL — ' . ($resource->name ?? 'Group ' . $resource->id))
...
<div class="container py-4">
  <nav aria-label="{{ __('breadcrumb') }}">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">{{ __('Taxonomy') }}</li>
    </ol>
  </nav>
  ...
  @include('ahg-acl::_term-acl-form', [
      'resource' => $resource,
      'termActions' => $basicActions,
      'taxonomyPermissions' => $taxonomies,
      'taxonomyObjects' => $taxonomyEntities ?? [],
