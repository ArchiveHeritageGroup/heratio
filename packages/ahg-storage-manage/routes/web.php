...
// ---------------------------------------------------------------------------
// heratio#144 — Strongroom space allocation
// ---------------------------------------------------------------------------
...
// Specific routes already declared above ('browse', 'add'); the catch-all
// {slug} must come last and excludes those paths so they aren't swallowed.
