  ...
  <div class="col-md-9">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <form method="POST" action="{{ route('reports.spatial') }}">
          ...
          <div class="d-flex gap-2 mb-4">
            <button type="submit" class="btn btn-primary" onclick="document.getElementById('exportField').value=''"><i class="fas fa-eye me-1"></i>Preview</button>
            <button type="submit" class="btn btn-success" onclick="document.getElementById('exportField').value='csv'"><i class="fas fa-file-csv me-1"></i>Export CSV</button>
            <button type="submit" class="btn btn-info text-white" onclick="document.getElementById('exportField').value='json'"><i class="fas fa-file-code me-1"></i>Export JSON</button>
          </div>
        </form>
      ...
      <div class="col-md-4">
        {{-- Export Buttons --}}
        <div class="card mb-3">
          <div class="card-header bg-success text-white"><i class="fas fa-download me-2"></i>Export</div>
          <div class="card-body">
