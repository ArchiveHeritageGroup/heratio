...
<div class="row">
  ...
  <div class="col-md-9">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1><i class="fas fa-sliders-h me-2"></i>Landing Configuration</h1>
    </div>
    <p class="text-muted">Configure the heritage landing page content and layout.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-sliders-h me-2"></i>Landing Configuration</div>
      <div class="card-body">
