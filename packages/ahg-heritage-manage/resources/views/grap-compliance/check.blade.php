...
<div class="row">
  ...
  <div class="col-md-9">
    <h1><i class="fas fa-clipboard-check me-2"></i>{{ __('Compliance Check') }}</h1>
    <p class="text-muted">Check compliance status for a specific asset.</p>
    ...
    <div class="card">
      <div class="card-header" style="background:var(--ahg-primary);color:#fff"><i class="fas fa-clipboard-check me-2"></i>{{ __('Compliance Check') }}</div>
      <div class="card-body">
        @if(!empty($items))
