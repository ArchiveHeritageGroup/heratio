    ...
    <form method="post" action="{{ route('settings.numbering-scheme-edit', ['id' => $schemeId ?? null]) }}">
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="card mb-4">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    <label class="form-label">Sector <span class="badge bg-danger ms-1">Required</span></label>
          ...
          <div class="card mb-4">
            <div class="card-header"><i class="fas fa-code me-2"></i>Pattern Builder</div>
            <div class="card-body">
              <div class="mb-3">
                <label class="form-label">Pattern <span class="badge bg-danger ms-1">Required</span></label>
          ...
          <div class="card mb-4">
            <div class="card-header"><i class="fas fa-cog me-2"></i>Options</div>
            <div class="card-body">
              <div class="row">
                <div class="col-md-4">
                  <div class="mb-3">
