                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('ahgvendor.view', ['slug' => $vendor->slug]) }}" class="btn btn-outline-primary" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('ahgvendor.edit', ['slug' => $vendor->slug]) }}" class="btn btn-outline-secondary" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="{{ route('ahgvendor.add-transaction', ['vendor' => $vendor->slug]) }}" class="btn btn-outline-success" title="New Transaction">
