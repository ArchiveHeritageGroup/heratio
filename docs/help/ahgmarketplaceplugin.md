...
The ahgMarketplacePlugin provides a comprehensive online marketplace for GLAM and DAM institutions built on the Heratio (Heratio) archival platform. It supports fixed-price sales, make-an-offer negotiations, and timed auctions with anti-sniping protection across all five GLAM/DAM sectors (Gallery, Museum, Archive, Library, DAM).
...
- **`marketplace_listing.information_object_id`**: Links listing to Heratio information_object, which may have gallery CCO metadata
...
*Part of the Heratio AHG Framework (Heratio) - Version 1.0.0*
