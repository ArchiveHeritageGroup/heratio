...
@section('title', 'Spectrum Workflow')

@section('content')
<h1>Spectrum Workflow</h1>
  ...
  <div class="accordion mb-3">
    <div class="accordion-item">
      <h2 class="accordion-header">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#main-collapse" aria-expanded="true">Spectrum Workflow</button>
      </h2>
