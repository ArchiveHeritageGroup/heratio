...
### Standard Heratio (native Symfony CLI)
...
**Official Heratio documentation:** [CLI import/export](https://www.accesstomemory.org/en/docs/2.10/admin-manual/maintenance/cli-import-export/#digital-object-load-task)
...
- The optional `digitalObjectChecksum` column lets Heratio skip re-importing unchanged files during update imports
