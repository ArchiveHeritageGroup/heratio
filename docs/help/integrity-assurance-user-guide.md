...
- **Email**: Sent via the configured SwiftMailer (same as Heratio's email system)
...
### Alerts not sending
1. Verify email configuration in Heratio's `apps/qubit/config/factories.yml` (mailer section)
