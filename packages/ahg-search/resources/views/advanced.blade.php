        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            ...
            <select id="adv-sort" name="sort" class="form-select">
              ...
              <option value="titleDesc" {{ $sort === 'titleDesc' ? 'selected' : '' }}>{{ __('Title (Z-A)') }}</option>
              <option value="dateDesc" {{ $sort === 'dateDesc' ? 'selected' : '' }}>{{ __('Date (newest first)') }}</option>
              <option value="dateAsc" {{ $sort === 'dateAsc' ? 'selected' : '' }}>{{ __('Date (oldest first)') }}</option>
              <option value="identifierAsc" {{ $sort === 'identifierAsc' ? 'selected' : '' }}>{{ __('Identifier (A-Z)') }}</option>
              <option value="lastUpdated" {{ $sort === 'lastUpdated' ? 'selected' : '' }}>{{ __('Last updated') }}</option>
            </select>
          </div>
        </div>
