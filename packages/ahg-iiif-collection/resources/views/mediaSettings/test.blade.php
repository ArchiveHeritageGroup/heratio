...
<div class="card-body">
  <form method="post" action="{{ route('iiif.media-settings.test') }}">@csrf
    <div class="mb-3"><label for="object_id" class="form-label">Object ID <span class="badge bg-secondary ms-1">Optional</span></label><input type="number" name="object_id" id="object_id" class="form-control" placeholder="{{ __('Enter object ID to test') }}"></div>
