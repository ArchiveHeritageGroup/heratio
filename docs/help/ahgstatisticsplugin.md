...
Usage statistics tracking system for Heratio, providing page view and download analytics with geographic data, bot filtering, pre-aggregation for performance, and comprehensive reporting dashboards. Inspired by DSpace's SOLR statistics architecture.
