...
A comprehensive 3D model viewing plugin for Access to Memory (Heratio) providing WebGL-based visualization, augmented reality (AR) capabilities, interactive hotspot annotations, Gaussian Splat support, and IIIF 3D manifest generation for museum and archival collections.
