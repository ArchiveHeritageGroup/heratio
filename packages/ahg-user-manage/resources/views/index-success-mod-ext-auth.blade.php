{{-- External auth user show/index variant - ported from AtoM ahgThemeB5Plugin/modules/user/templates/indexSuccess.mod_ext_auth.php --}}
{{-- Same as CAS show: displays user details without password fields --}}
...
@include('ahg-user-manage::_show-actions-mod-ext-auth', ['user' => $user])
