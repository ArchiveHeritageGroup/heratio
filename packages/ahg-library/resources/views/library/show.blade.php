      ...
      <div class="list-group list-group-flush">
        ...
        @if(\Illuminate\Support\Facades\Route::has('io.spectrum'))
          <a href="{{ route('io.spectrum', $item->slug) }}" class="list-group-item list-group-item-action small">
            <i class="fas fa-layer-group me-2"></i>{{ __('Collections Procedure') }}
          </a>
        @endif
    ...
    <li>
      <div class="dropdown d-inline-block">
        ...
        <ul class="dropdown-menu">
          ...
          @if(\Illuminate\Support\Facades\Route::has('io.spectrum'))
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="{{ route('io.spectrum', $item->slug) }}"><i class="fas fa-layer-group me-2"></i>{{ __('Collections Procedure') }}</a></li>
            @if(\Illuminate\Support\Facades\Route::has('ahgspectrum.workflow'))
    ...
    document.getElementById('nerExtractBtn').addEventListener('click', function() {
      ...
      .then(function(data) {
        ...
        for (var type in entities) {
          ...
          html += '<div class="mb-3"><h6><i class="fas ' + icon + ' me-1 text-' + color + '"></i>' + labelFor(type) + ' <span class="badge bg-' + color + '">' + entities[type].length + '</span></h6>';
