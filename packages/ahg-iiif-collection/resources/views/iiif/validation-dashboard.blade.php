...
<div class="row mb-4">
  ...
  <div class="col-md-3"><div class="card text-center border-success"><div class="card-body py-3"><h3 class="text-success mb-0">{{ $stats['passed'] ?? 0 }}</h3><small class="text-muted">{{ __('Fully Compliant') }}</small></div></div></div>
  <div class="col-md-3"><div class="card text-center border-danger"><div class="card-body py-3"><h3 class="text-danger mb-0">{{ $stats['failed'] ?? 0 }}</h3><small class="text-muted">{{ __('Issues Found') }}</small></div></div></div>
  <div class="col-md-3"><div class="card text-center border-warning"><div class="card-body py-3"><h3 class="text-warning mb-0">{{ $stats['warning'] ?? 0 }}</h3><small class="text-muted">{{ __('Warnings') }}</small></div></div></div>
</div>
