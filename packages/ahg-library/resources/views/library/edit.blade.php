      ...
      <div class="col-md-8">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                <label for="level_of_description_id" class="form-label required">Level of description</label>
        ...
        <section class="card mb-4">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-3 mb-3">
                <label class="form-label">Open Library ID</label>
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                <label class="form-label">Goodreads ID</label>
              ...
              <div class="col-md-4 mb-3">
                <label class="form-label">LibraryThing ID</label>
              ...
              <div class="col-md-4 mb-3">
                <label class="form-label">Open Library URL</label>
                <div class="input-group">
        ...
        <section class="card mb-4">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                <label class="form-label">Classification scheme</label>
              ...
              <div class="col-md-4 mb-3">
                <label for="call_number" class="form-label">Call number (LC)</label>
            ...
            <div class="row">
              ...
              <div class="col-md-3 mb-3">
                <label for="volume_designation" class="form-label">Volume</label>
        ...
        <section class="card mb-4">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                <label for="pagination" class="form-label">Pages</label>
        ...
        <section class="card mb-4">
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              <label for="contents_note" class="form-label">Table of contents</label>
