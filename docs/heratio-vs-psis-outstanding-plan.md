...
- [ ] **X.1** ahg-marketplace service-method backfill (55 methods → 11 batches of 5)
  ...
  - [ ] X.1.6 Categories / currencies / settings (7): `createCategory`, `updateCategory`, `deleteCategory`, `addCurrency`, `updateCurrency`, `getAllSettings`, `setSetting` — **do PSIS-diff FIRST this time (no more minimum-viable implementations)**
