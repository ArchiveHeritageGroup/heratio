...
Centralized settings management plugin providing a unified admin interface for configuring Heratio core settings, AHG plugins, themes, AI services, API keys, email, numbering schemes, and preservation settings. Consolidates scattered configuration options into a single dashboard.
...
```json
{
    ...
    "version": "1.0.1",
    "description": "Extended settings management for Heratio",
